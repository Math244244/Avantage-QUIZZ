import{A as w,B as ue,p as me,g as pe,d as ee,x as f,f as ge,w as m,e as he,v as d,n as T,y as ve}from"./auth-BXQxSF3z.js";import{s as I,e as fe,f as be,c as we,b as j,g as W}from"./skeleton-bh2HAV7A.js";import{getDocs as M,collection as C,query as te,orderBy as oe,limit as se}from"https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js";import{g as xe,a as ye,c as Ee,d as Se,i as Ae}from"./question-service-DATo6D6V.js";import{s as x}from"./state-manager-w7-wWzCS.js";import"https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/10.7.1/firebase-auth.js";import"https://www.gstatic.com/firebasejs/10.7.1/firebase-database.js";class Le{constructor(){this.activeTooltip=null,this.hoverDelay=300,this.hideDelay=100,this.hoverTimer=null,this.hideTimer=null,this.isTouchDevice="ontouchstart"in window,this.init()}init(){console.log("🎯 Initialisation du système de tooltips"),this.createTooltipContainer(),this.initializeTooltips(),this.observeDOM(),console.log("✅ Système de tooltips initialisé")}createTooltipContainer(){let e=document.getElementById("tooltip-container");e||(e=document.createElement("div"),e.id="tooltip-container",e.className="fixed pointer-events-none z-[9999]",document.body.appendChild(e)),this.container=e}initializeTooltips(){const e=document.querySelectorAll("[data-tooltip]");e.forEach(o=>this.attachTooltip(o)),console.log(`📌 ${e.length} tooltips initialisés`)}observeDOM(){new MutationObserver(o=>{o.forEach(s=>{s.addedNodes.forEach(a=>{a.nodeType===1&&(a.hasAttribute&&a.hasAttribute("data-tooltip")&&this.attachTooltip(a),a.querySelectorAll&&a.querySelectorAll("[data-tooltip]").forEach(n=>{this.attachTooltip(n)}))})})}).observe(document.body,{childList:!0,subtree:!0})}attachTooltip(e){e.dataset.tooltipAttached||(e.dataset.tooltipAttached="true",!this.isTouchDevice&&(e.addEventListener("mouseenter",o=>this.handleMouseEnter(o,e)),e.addEventListener("mouseleave",o=>this.handleMouseLeave(o)),e.addEventListener("focus",o=>this.handleFocus(o,e)),e.addEventListener("blur",o=>this.handleBlur(o)),e.setAttribute("aria-describedby",`tooltip-${this.generateId()}`)))}generateId(){return Math.random().toString(36).substring(2,11)}handleMouseEnter(e,o){clearTimeout(this.hideTimer),this.hoverTimer=setTimeout(()=>{this.showTooltip(o)},this.hoverDelay)}handleMouseLeave(e){clearTimeout(this.hoverTimer),this.hideTimer=setTimeout(()=>{this.hideTooltip()},this.hideDelay)}handleFocus(e,o){this.showTooltip(o)}handleBlur(e){this.hideTooltip()}showTooltip(e){const o=e.dataset.tooltip,s=e.dataset.tooltipPosition||"top",a=e.dataset.tooltipTheme||"dark",n=e.dataset.tooltipSize||"medium";if(!o)return;this.hideTooltip();const r=this.createTooltipElement(o,a,n);this.container.appendChild(r),this.activeTooltip=r,this.positionTooltip(r,e,s),setTimeout(()=>{r.classList.remove("opacity-0","scale-95"),r.classList.add("opacity-100","scale-100")},10)}createTooltipElement(e,o,s){const a=document.createElement("div");return a.className=`tooltip absolute opacity-0 scale-95 transform transition-all duration-200 ease-out ${this.getThemeClasses(o)} ${this.getSizeClasses(s)}`,a.innerHTML=`
        ...
        `,a}getThemeClasses(e){const o={dark:"bg-slate-900 text-white shadow-lg",light:"bg-white text-slate-900 shadow-lg border border-slate-200",success:"bg-green-600 text-white shadow-lg",error:"bg-red-600 text-white shadow-lg",warning:"bg-orange-600 text-white shadow-lg",info:"bg-blue-600 text-white shadow-lg"};return o[e]||o.dark}getSizeClasses(e){const o={small:"text-xs px-2 py-1 rounded",medium:"text-sm px-3 py-2 rounded-md",large:"text-base px-4 py-3 rounded-lg"};return o[e]||o.medium}getArrowClasses(e){const o={dark:"bg-slate-900",light:"bg-white border-l border-b border-slate-200",success:"bg-green-600",error:"bg-red-600",warning:"bg-orange-600",info:"bg-blue-600"};return o[e]||o.dark}positionTooltip(e,o,s){const a=o.getBoundingClientRect(),n=e.getBoundingClientRect(),r=e.querySelector(".tooltip-arrow"),l=8,i=8,c={top:{top:a.top-n.height-l,left:a.left+a.width/2-n.width/2,arrowTop:n.height-i/2,arrowLeft:n.width/2-i/2,arrowRotate:"rotate(45deg)"},bottom:{top:a.bottom+l,left:a.left+a.width/2-n.width/2,arrowTop:-i/2,arrowLeft:n.width/2-i/2,arrowRotate:"rotate(225deg)"},left:{top:a.top+a.height/2-n.height/2,left:a.left-n.width-l,arrowTop:n.height/2-i/2,arrowLeft:n.width-i/2,arrowRotate:"rotate(135deg)"},right:{top:a.top+a.height/2-n.height/2,left:a.right+l,arrowTop:n.height/2-i/2,arrowLeft:-i/2,arrowRotate:"rotate(315deg)"}};let g=s;const u=c[s];if(u&&(u.top<0||u.top+n.height>window.innerHeight||u.left<0||u.left+n.width>window.innerWidth)){const de=["top","bottom","left","right"];for(const V of de){const q=c[V];if(!(q.top<0||q.top+n.height>window.innerHeight||q.left<0||q.left+n.width>window.innerWidth)){g=V;break}}}const p=c[g]||c.top;e.style.top=`${p.top}px`,e.style.left=`${p.left}px`,r&&(r.style.top=`${p.arrowTop}px`,r.style.left=`${p.arrowLeft}px`,r.style.transform=p.arrowRotate)}hideTooltip(){this.activeTooltip&&(this.activeTooltip.classList.remove("opacity-100","scale-100"),this.activeTooltip.classList.add("opacity-0","scale-95"),setTimeout(()=>{this.activeTooltip&&this.activeTooltip.parentNode&&this.activeTooltip.parentNode.removeChild(this.activeTooltip),this.activeTooltip=null},200))}add(e,o,s={}){e.dataset.tooltip=o,e.dataset.tooltipPosition=s.position||"top",e.dataset.tooltipTheme=s.theme||"dark",e.dataset.tooltipSize=s.size||"medium",this.attachTooltip(e)}remove(e){e.removeAttribute("data-tooltip"),e.removeAttribute("data-tooltip-position"),e.removeAttribute("data-tooltip-theme"),e.removeAttribute("data-tooltip-size"),e.removeAttribute("data-tooltip-attached"),e.removeAttribute("aria-describedby")}update(e,o,s={}){this.remove(e),this.add(e,o,s)}destroy(){this.container&&this.container.parentNode&&this.container.parentNode.removeChild(this.container),clearTimeout(this.hoverTimer),clearTimeout(this.hideTimer),console.log("🗑️ Système de tooltips détruit")}}const Te=new Le;window.tooltip=Te;async function Me(){return new Promise((t,e)=>{if(w()){const s=ue();if(s&&s.role==="admin"){console.log("✅ Admin autorisé (mode démo):",s.email),t(s);return}else{console.warn("❌ Accès refusé: utilisateur démo non admin"),alert("Accès refusé. Cette page est réservée aux administrateurs."),window.location.href="/index.html",e(new Error("Non autorisé"));return}}const o=me.onAuthStateChanged(async s=>{if(o(),!s){console.warn("❌ Accès refusé: Utilisateur non connecté"),window.location.href="/index.html",e(new Error("Non authentifié"));return}try{const a=await pe(s.uid);if(!a||a.role!=="admin"){console.warn("❌ Accès refusé: Utilisateur non administrateur"),alert("Accès refusé. Cette page est réservée aux administrateurs."),window.location.href="/index.html",e(new Error("Non autorisé"));return}console.log("✅ Admin autorisé:",s.email),t(s)}catch(a){console.error("❌ Erreur vérification admin:",a),window.location.href="/index.html",e(a)}})})}const ae="avantage-quizz-demo-questions";function Ce(){if(!w())return[];const t=localStorage.getItem(ae);if(t)try{return JSON.parse(t).map(o=>({...o,createdAt:new Date(o.createdAt)}))}catch(e){console.warn("⚠️ Erreur lecture questions démo:",e)}return[{id:"1",module:"auto",month:11,year:2025,question:"Quelle est la pression recommandée pour les pneus d'une voiture standard ?",options:["32 PSI","25 PSI","40 PSI","50 PSI"],correctAnswer:0,explanation:"La pression recommandée est généralement de 32 PSI pour un véhicule standard.",createdAt:new Date},{id:"2",module:"auto",month:11,year:2025,question:"À quelle fréquence doit-on changer l'huile moteur ?",options:["Tous les 5000 km","Tous les 10000 km","Tous les 15000 km","Tous les 20000 km"],correctAnswer:1,explanation:"Il est recommandé de changer l'huile tous les 10000 km ou selon les recommandations du fabricant.",createdAt:new Date},{id:"3",module:"loisir",month:11,year:2025,question:"Quel est le poids maximal recommandé pour un bateau remorqué ?",options:["1500 kg","2000 kg","2500 kg","3000 kg"],correctAnswer:2,explanation:"Pour un véhicule standard, 2500 kg est souvent la limite recommandée.",createdAt:new Date},{id:"4",module:"vr",month:10,year:2025,question:"Quelle est la capacité minimale recommandée pour une batterie de VR ?",options:["75 Ah","100 Ah","125 Ah","150 Ah"],correctAnswer:1,explanation:"Une batterie de 100 Ah est le minimum recommandé pour un VR.",createdAt:new Date},{id:"5",module:"tracteur",month:10,year:2025,question:"À quelle profondeur doit-on labourer pour les cultures céréalières ?",options:["10-15 cm","20-25 cm","30-35 cm","40-45 cm"],correctAnswer:1,explanation:"La profondeur idéale est de 20-25 cm pour les céréales.",createdAt:new Date}]}function R(t){w()&&(localStorage.setItem(ae,JSON.stringify(t)),console.log("💾 Questions démo sauvegardées:",t.length))}let $=Ce();const $e={total:240,byModule:{auto:85,loisir:62,vr:54,tracteur:39},recent:12};let S=[],y={module:"",month:"",year:new Date().getFullYear()},A=1;const N=20;async function ze(){console.log("Initialisation du gestionnaire de questions"),await z(),await D(),De()}function De(){const t=document.getElementById("create-question-form");t&&t.addEventListener("submit",Ie);const e=document.getElementById("json-file-input");e&&e.addEventListener("change",Be);const o=document.getElementById("browse-json-btn");o&&o.addEventListener("click",()=>e?.click());const s=document.getElementById("filter-module"),a=document.getElementById("filter-month"),n=document.getElementById("filter-year"),r=document.getElementById("search-questions"),l=document.getElementById("questions-list");s&&s.addEventListener("change",H),a&&a.addEventListener("change",H),n&&n.addEventListener("change",H),r&&r.addEventListener("input",He),l&&!l.dataset.eventsBound&&(l.addEventListener("click",ke),l.dataset.eventsBound="true");const i=document.getElementById("prev-page-btn"),c=document.getElementById("next-page-btn");i&&i.addEventListener("click",()=>J(-1)),c&&c.addEventListener("click",()=>J(1))}function ke(t){const e=t.target.closest(".edit-question-btn, .delete-question-btn");if(!e)return;const o=e.dataset.questionId;if(o){if(e.classList.contains("edit-question-btn")){Qe(o);return}e.classList.contains("delete-question-btn")&&je(o)}}async function z(){try{if(document.getElementById("questions-list")&&I("questions-list",fe(5)),w()){console.log("📝 Mode démo : Chargement des questions simulées..."),await new Promise(o=>setTimeout(o,500)),S=$.filter(o=>!(y.module&&o.module!==y.module||y.month&&o.month!==parseInt(y.month)||y.year&&o.year!==parseInt(y.year))),console.log(`✅ ${S.length} questions simulées chargées`),U();return}const e={};y.module&&(e.module=y.module),y.month&&(e.month=parseInt(y.month)),y.year&&(e.year=parseInt(y.year)),S=await xe(e),console.log(`Questions chargees: ${S.length}`),U()}catch(t){console.error("Erreur chargement questions:",t);const e=document.getElementById("questions-list");e&&(e.innerHTML=`
            ...
            `)}}function U(){const t=document.getElementById("questions-list");if(!t)return;if(S.length===0){const n=document.createElement("div");n.className="text-center py-12 text-slate-500",n.innerHTML=`
            ...
            <div class="flex items-start justify-between mb-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="ml-2 text-sm text-slate-500">${L(`${r} ${t.year}`)}</span>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg p-4 mb-4 max-h-60 overflow-y-auto">
                ...
                <ol class="space-y-2 text-sm text-slate-700">
                    ${t.questions.slice(0,5).map((n,r)=>`
                        <li><strong>${r+1}.</strong> ${L(n.question.substring(0,80))}${n.question.length>80?"...":""}</li>
                    `).join("")}
    ...
    `,document.getElementById("confirm-import-btn")?.addEventListener("click",()=>Ue(t)),document.getElementById("cancel-import-btn")?.addEventListener("click",()=>{o.innerHTML="",document.getElementById("json-file-input").value=""})}async function Ue(t){const e=document.getElementById("json-preview"),o=document.getElementById("confirm-import-btn");try{if(o.disabled=!0,o.innerHTML='<svg class="animate-spin h-5 w-5 inline" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle></svg> Import en cours...',w()){console.log("📝 Mode démo : Simulation import JSON..."),await new Promise(n=>setTimeout(n,1e3));const a=t.questions||[];a.forEach((n,r)=>{$.unshift({id:`demo-imported-${Date.now()}-${r}`,question:n.question,options:n.options,correctAnswer:n.correctAnswer,explanation:n.explanation||"Pas d'explication fournie",module:t.module,month:t.month,year:t.year,createdAt:new Date})}),R($),k(`✅ Import terminé (mode démo): ${a.length} questions importées`),e.innerHTML="",document.getElementById("json-file-input").value="",await z(),await D();return}const s=await Ae(t);k(`Import termine: ${s.success}/${s.total} questions importees`),s.errors.length>0&&console.warn("Erreurs import:",s.errors),e.innerHTML="",document.getElementById("json-file-input").value="",await z(),await D()}catch(s){console.error("Erreur import:",s),Q("json-preview",s.message||"Erreur lors de l import")}}function Qe(t){S.find(o=>o.id===t)&&alert(`Edition de la question ${t}
...
Cette action est irreversible.`)))try{if(w()){console.log("📝 Mode démo : Simulation suppression question..."),await new Promise(a=>setTimeout(a,300));const s=$.findIndex(a=>a.id===t);s>-1&&($.splice(s,1),R($)),k("✅ Question supprimée avec succès (mode démo)"),await z(),await D();return}await Se(t),k("Question supprimee avec succes"),await z(),await D()}catch(s){console.error("Erreur suppression:",s),Q("questions-list",s.message||"Erreur lors de la suppression")}}async function H(t){const e=t.target.id.replace("filter-","");y[e]=t.target.value,A=1,await z()}function He(t){const e=t.target.value.toLowerCase();if(!e){U();return}const o=S.filter(n=>n.question.toLowerCase().includes(e)||n.options.some(r=>r.toLowerCase().includes(e))||n.explanation.toLowerCase().includes(e)),s=document.getElementById("questions-list");if(!s)return;if(o.length===0){const n=document.createElement("div");n.className="text-center py-12 text-slate-500",n.innerHTML=`
            <p class="text-lg">Aucun resultat pour "${L(e)}"</p>
        `,s.replaceChildren(n);return}const a=document.createDocumentFragment();o.forEach(n=>{a.appendChild(ne(n))}),s.replaceChildren(a)}function J(t){const e=Math.ceil(S.length/N);A+=t,A<1&&(A=1),A>e&&(A=e),U(),window.scrollTo({top:0,behavior:"smooth"})}function Fe(){const t=Math.ceil(S.length/N),e=document.getElementById("page-info"),o=document.getElementById("prev-page-btn"),s=document.getElementById("next-page-btn");e&&(e.textContent=`Page ${A}/${t||1}`),o&&(o.disabled=A===1),s&&(s.disabled=A===t||t===0)}async function D(){try{if(w()){console.log("📊 Mode démo : Chargement des stats simulées..."),G($e);return}const t=await ye();G(t)}catch(t){console.error("Erreur chargement stats:",t)}}function G(t){const e=document.getElementById("questions-stats");if(!e)return;const o={auto:"Auto",loisir:"Loisir",vr:"VR",tracteur:"Tracteur"};e.innerHTML=`
    ...
    `}function k(t){const e=document.createElement("div");e.className="fixed top-4 right-4 bg-green-500 text-white px-6 py-4 rounded-lg shadow-xl z-50 animate-fade-in",e.innerHTML=`
        <div class="flex items-center gap-3">
...
Copiez-le manuellement.`,7e3)}))}function F(t,e){t.textContent=e,t.classList.remove("hidden"),t.scrollIntoView({behavior:"smooth",block:"nearest"})}async function P(){try{if(document.getElementById("users-list")&&I("users-list",be(10)),w()){console.log("👥 Mode démo : Chargement des utilisateurs simulés..."),await new Promise(s=>setTimeout(s,500)),v=Pe.filter(s=>{if(b.role&&s.role!==b.role)return!1;if(b.status!=="all"){const a=new Date;a.setDate(a.getDate()-7);const r=s.lastLogin>a;if(b.status==="active"&&!r||b.status==="inactive"&&r)return!1}return!0}),console.log(`✅ ${v.length} utilisateurs simulés chargés`),B();return}const e={};b.role&&(e.role=b.role),h.lastDoc=null,h.hasMore=!1;const o=await ee(e,h.pageSize,null);if(v=o.users,h.lastDoc=o.lastDoc,h.hasMore=o.hasMore,b.status!=="all"){const s=new Date;s.setDate(s.getDate()-7),v=v.filter(a=>{if(!a.lastLogin)return b.status==="inactive";const r=(a.lastLogin.toDate?a.lastLogin.toDate():new Date(a.lastLogin))>s;return b.status==="active"?r:!r})}console.log(`Utilisateurs charges: ${v.length}`),B(),re()}catch(t){console.error("Erreur chargement utilisateurs:",t);const e=document.getElementById("users-list");if(e){const o=f(t.message);e.innerHTML=`
                <div class="text-center py-12 text-red-500">
                    <svg class="w-16 h-16 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
            ...
            `}}}function B(){const t=document.getElementById("users-list");if(t){if(v.length===0){t.innerHTML=`
        ...
        `;return}t.innerHTML=v.map(e=>_e(e)).join(""),Ze()}}async function Ke(){if(!(h.isLoading||!h.hasMore))try{h.isLoading=!0;const t={};b.role&&(t.role=b.role);const e=await ee(t,h.pageSize,h.lastDoc);let o=e.users;if(b.status!=="all"){const s=new Date;s.setDate(s.getDate()-7),o=o.filter(a=>{if(!a.lastLogin)return b.status==="inactive";const r=(a.lastLogin.toDate?a.lastLogin.toDate():new Date(a.lastLogin))>s;return b.status==="active"?r:!r})}v=[...v,...o],h.lastDoc=e.lastDoc,h.hasMore=e.hasMore,B(),re(),console.log(`✅ ${o.length} utilisateurs supplémentaires chargés`)}catch(t){console.error("❌ Erreur chargement utilisateurs supplémentaires:",t),m.error("Erreur lors du chargement des utilisateurs supplémentaires")}finally{h.isLoading=!1}}function re(){const t=document.getElementById("users-pagination-controls");if(t&&t.remove(),!h.hasMore&&v.length<=h.pageSize)return;const e=document.getElementById("users-list");if(!e)return;const o=`
    ...
    `,document.body.appendChild(s),document.getElementById("close-modal-btn")?.addEventListener("click",()=>s.remove()),document.getElementById("cancel-role-btn")?.addEventListener("click",()=>s.remove()),document.getElementById("save-role-btn")?.addEventListener("click",async()=>{const a=s.querySelector('input[name="role"]:checked')?.value;a&&(await et(t,e,a),s.remove())}),s.addEventListener("click",a=>{a.target===s&&s.remove()})}async function et(t,e,o){const s=document.getElementById("save-role-btn");if(!s)return;const a=s.innerHTML,n=m.showLoadingToast("Mise à jour du rôle...");try{s.disabled=!0,s.innerHTML='<svg class="animate-spin h-5 w-5 inline" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle></svg> Mise a jour...',await he(t,o),m.updateLoadingToast(n,`Rôle mis à jour pour ${e}`,"success"),ot(`Role mis a jour pour ${e}: ${o==="admin"?"Admin":"User"}`),await P(),await ie()}catch(r){console.error("Erreur mise a jour role:",r),m.updateLoadingToast(n,"Erreur de mise à jour","error"),m.error(`Erreur: ${r.message||"Impossible de mettre a jour le role"}`,4e3),s.disabled=!1,s.innerHTML=a}}async function K(t){const e=t.target.id.replace("filter-user-","").replace("-","");b[e]=t.target.value,await P()}function tt(t){const e=t.target.value.toLowerCase();if(!e){B();return}const o=v.filter(n=>n.displayName&&n.displayName.toLowerCase().includes(e)||n.email&&n.email.toLowerCase().includes(e)),s=document.getElementById("users-list");if(!s)return;if(o.length===0){const n=f(e);s.innerHTML=`
            <div class="text-center py-12 text-slate-500">
                <p class="text-lg">Aucun resultat pour "${n}"</p>
            </div>
        `;return}const a=v;v=o,B(),v=a}async function ie(){try{if(w()){console.log("📊 Mode démo : Chargement des stats utilisateurs simulées..."),_(Oe);return}const t=await ge();_(t)}catch(t){console.error("Erreur chargement stats:",t)}}function _(t){const e=document.getElementById("users-stats");if(!e)return;const o=t.total>0?Math.round(t.activeLastWeek/t.total*100):0;e.innerHTML=`
        <div class="bg-white rounded-xl shadow-md p-6">
    ...
    `}function ot(t){const e=document.createElement("div");e.className="fixed top-4 right-4 bg-green-500 text-white px-6 py-4 rounded-lg shadow-xl z-50 animate-fade-in";const o=f(t);e.innerHTML=`
        <div class="flex items-center gap-3">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
            </svg>
    ...
    `,document.body.appendChild(e),setTimeout(()=>{e.remove()},3e3)}function st(t){const o=new Date-t,s=Math.floor(o/6e4),a=Math.floor(o/36e5),n=Math.floor(o/864e5);return s<1?"A l instant":s<60?`Il y a ${s} min`:a<24?`Il y a ${a}h`:n===1?"Hier":n<7?`Il y a ${n} jours`:n<30?`Il y a ${Math.floor(n/7)} semaines`:t.toLocaleDateString("fr-FR")}const O={stats:{totalUsers:42,totalQuizzes:156,totalQuestions:240,totalResources:35,avgScore:78,activeUsersToday:8,activeUsersWeek:23,quizzesToday:12,quizzesWeek:67},topUsers:[{id:"1",email:"alice.dupont@example.com",displayName:"Alice Dupont",totalQuizzes:24,averageScore:92},{id:"2",email:"bob.martin@example.com",displayName:"Bob Martin",totalQuizzes:21,averageScore:88},{id:"3",email:"claire.bernard@example.com",displayName:"Claire Bernard",totalQuizzes:19,averageScore:85},{id:"4",email:"david.dubois@example.com",displayName:"David Dubois",totalQuizzes:18,averageScore:83},{id:"5",email:"emma.petit@example.com",displayName:"Emma Petit",totalQuizzes:16,averageScore:81},{id:"6",email:"francois.roux@example.com",displayName:"François Roux",totalQuizzes:15,averageScore:79},{id:"7",email:"julie.moreau@example.com",displayName:"Julie Moreau",totalQuizzes:14,averageScore:76},{id:"8",email:"lucas.simon@example.com",displayName:"Lucas Simon",totalQuizzes:13,averageScore:74},{id:"9",email:"marie.laurent@example.com",displayName:"Marie Laurent",totalQuizzes:12,averageScore:72},{id:"10",email:"nicolas.michel@example.com",displayName:"Nicolas Michel",totalQuizzes:11,averageScore:70}],recentActivity:[{id:"1",userName:"Alice Dupont",module:"Auto - Novembre",score:95,completedAt:new Date(Date.now()-3e5)},{id:"2",userName:"Emma Petit",module:"Loisir - Novembre",score:90,completedAt:new Date(Date.now()-72e4)},{id:"3",userName:"Bob Martin",module:"VR - Novembre",score:88,completedAt:new Date(Date.now()-138e4)},{id:"4",userName:"Claire Bernard",module:"Auto - Octobre",score:82,completedAt:new Date(Date.now()-27e5)},{id:"5",userName:"David Dubois",module:"Tracteur - Octobre",score:79,completedAt:new Date(Date.now()-36e5)}],moduleStats:[{module:"Auto",questionsCount:85,avgScore:76,completions:67},{module:"Loisir",questionsCount:62,avgScore:81,completions:45},{module:"VR",questionsCount:54,avgScore:73,completions:32},{module:"Tracteur",questionsCount:39,avgScore:79,completions:28}]};x.set("globalStats",{totalUsers:0,totalQuizzes:0,totalQuestions:0,totalResources:0,avgScore:0,activeUsersToday:0,activeUsersWeek:0,quizzesToday:0,quizzesWeek:0});x.set("chartProgress",null);x.set("chartModules",null);x.set("chartActivity",null);async function le(){d.info("📊 Initialisation du dashboard admin avancé"),ht();try{await Promise.all([at(),nt(),rt(),ce()]),it(),pt(),m.success("Dashboard chargé avec succès !",3e3)}catch(t){d.error("❌ Erreur chargement dashboard:",t),m.error("Erreur lors du chargement du dashboard",4e3)}}async function at(){try{let t=x.get("globalStats");if(w()){d.info("📊 Mode démo : Chargement des statistiques simulées..."),t=O.stats,x.set("globalStats",t),Y(),d.info("✅ Statistiques simulées chargées:",t);return}d.info("📈 Chargement des statistiques globales...");const e=await M(C(T,"users"));t.totalUsers=e.size;const o=await M(C(T,"quizResults"));t.totalQuizzes=o.size;let s=0;o.forEach(p=>{s+=p.data().score||0}),t.avgScore=o.size>0?Math.round(s/o.size):0;const a=await M(C(T,"questions"));t.totalQuestions=a.size;const n=await M(C(T,"resources"));t.totalResources=n.size;const r=new Date;r.setHours(0,0,0,0);let l=0;e.forEach(p=>{const E=p.data().lastLogin?.toDate();E&&E>=r&&l++}),t.activeUsersToday=l;const i=new Date;i.setDate(i.getDate()-7);let c=0;e.forEach(p=>{const E=p.data().lastLogin?.toDate();E&&E>=i&&c++}),t.activeUsersWeek=c;let g=0;o.forEach(p=>{const E=p.data().completedAt?.toDate();E&&E>=r&&g++}),t.quizzesToday=g;let u=0;o.forEach(p=>{const E=p.data().completedAt?.toDate();E&&E>=i&&u++}),t.quizzesWeek=u,x.set("globalStats",t),Y(),d.info("✅ Statistiques globales chargées:",t)}catch(t){throw d.error("❌ Erreur chargement stats globales:",t),t}}async function nt(){try{if(w()){d.info("🏆 Mode démo : Chargement du top 10 simulé..."),Z(O.topUsers),d.info("✅ Top 10 simulé chargé");return}d.info("🏆 Chargement du top 10 utilisateurs...");const t=te(C(T,"quizResults"),oe("completedAt","desc"),se(1e3)),e=await M(t),o={};e.forEach(a=>{const n=a.data(),r=n.userId,l=n.score||0;o[r]||(o[r]={userId:r,userName:n.userName||"Utilisateur",totalQuizzes:0,totalScore:0,avgScore:0}),o[r].totalQuizzes++,o[r].totalScore+=l}),Object.values(o).forEach(a=>{a.avgScore=Math.round(a.totalScore/a.totalQuizzes)});const s=Object.values(o).sort((a,n)=>n.avgScore-a.avgScore).slice(0,10);Z(s),d.info("✅ Top 10 utilisateurs chargé:",s)}catch(t){throw d.error("❌ Erreur chargement top users:",t),t}}async function rt(){try{if(w()){d.info("📅 Mode démo : Chargement de l'activité simulée..."),X(O.recentActivity),d.info("✅ Activité simulée chargée");return}d.info("📅 Chargement de l'activité récente...");const t=te(C(T,"quizResults"),oe("completedAt","desc"),se(10)),e=await M(t),o=[];e.forEach(s=>{const a=s.data();o.push({id:s.id,userName:a.userName||"Utilisateur",module:a.module||"Module",score:a.score||0,completedAt:a.completedAt?.toDate()||new Date})}),X(o),d.info("✅ Activité récente chargée:",o)}catch(t){throw d.error("❌ Erreur chargement activité:",t),t}}async function ce(){try{if(w()){d.info("📊 Mode démo : Chargement des stats modules simulées...");const o={Auto:{count:85,totalScore:6460,avgScore:76},Loisir:{count:62,totalScore:5022,avgScore:81},VR:{count:54,totalScore:3942,avgScore:73},Tracteur:{count:39,totalScore:3081,avgScore:79}};return d.info("✅ Stats modules simulées chargées:",o),o}d.info("📊 Chargement des stats par module...");const t=await M(C(T,"quizResults")),e={};return t.forEach(o=>{const s=o.data(),a=s.module||"Autre";e[a]||(e[a]={count:0,totalScore:0,avgScore:0}),e[a].count++,e[a].totalScore+=s.score||0}),Object.values(e).forEach(o=>{o.avgScore=Math.round(o.totalScore/o.count)}),d.info("✅ Stats par module chargées:",e),e}catch(t){throw d.error("❌ Erreur chargement stats modules:",t),t}}function Y(){const t=document.getElementById("global-stats-cards");if(!t)return;const e=x.get("globalStats");t.innerHTML=`
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl p-6 text-white shadow-lg">
            ...
            <h3 class="text-3xl font-bold mb-1">${f(String(e.totalUsers))}</h3>
            <p class="text-blue-100 text-sm">Utilisateurs inscrits</p>
            <div class="mt-3 text-xs">
                <span class="bg-white/20 px-2 py-1 rounded">📅 ${e.activeUsersToday} aujourd'hui</span>
                <span class="bg-white/20 px-2 py-1 rounded ml-2">📆 ${e.activeUsersWeek} cette semaine</span>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-700 rounded-xl p-6 text-white shadow-lg">
            ...
            <h3 class="text-3xl font-bold mb-1">${e.totalQuizzes}</h3>
            <p class="text-green-100 text-sm">Quiz réalisés</p>
            <div class="mt-3 text-xs">
                <span class="bg-white/20 px-2 py-1 rounded">📅 ${e.quizzesToday} aujourd'hui</span>
                <span class="bg-white/20 px-2 py-1 rounded ml-2">📆 ${e.quizzesWeek} cette semaine</span>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-700 rounded-xl p-6 text-white shadow-lg">
            ...
            <h3 class="text-3xl font-bold mb-1">${e.avgScore}%</h3>
            <p class="text-purple-100 text-sm">Score moyen global</p>
            <div class="mt-3">
                <div class="bg-white/20 rounded-full h-2">
                    <div class="bg-white rounded-full h-2" style="width: ${e.avgScore}%"></div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-700 rounded-xl p-6 text-white shadow-lg">
            ...
            <h3 class="text-3xl font-bold mb-1">${e.totalQuestions}</h3>
            <p class="text-orange-100 text-sm">Questions disponibles</p>
            <div class="mt-3 text-xs">
                <span class="bg-white/20 px-2 py-1 rounded">📚 ${e.totalResources} ressources</span>
            </div>
        </div>
    `}function Z(t){const e=document.getElementById("top-users-list");if(!e)return;if(t.length===0){const s=document.createElement("div");s.className="text-center py-8 text-slate-500",s.innerHTML=`
        ...
        `,e.replaceChildren(s);return}const o=document.createDocumentFragment();t.forEach((s,a)=>{const n=a===0?"🥇":a===1?"🥈":a===2?"🥉":`${a+1}.`,r=a===0?"bg-yellow-50 border-yellow-200":a===1?"bg-slate-50 border-slate-200":a===2?"bg-orange-50 border-orange-200":"bg-white border-slate-200",l=s.userName||s.displayName||s.email||"Utilisateur",i=f(l),c=Number.isFinite(s.totalQuizzes)?s.totalQuizzes:0,g=Number.isFinite(s.avgScore)?s.avgScore:0,u=document.createElement("article");u.className=`flex items-center justify-between p-4 rounded-lg border ${r} hover:shadow-md transition-shadow`,u.innerHTML=`
            <div class="flex items-center gap-4">
                <span class="text-2xl font-bold w-8">${f(n)}</span>
                <div>
            ...
            <div class="text-right">
                <div class="text-2xl font-bold text-indigo-600">${f(`${g}%`)}</div>
        ...
        `,e.replaceChildren(s);return}const o=document.createDocumentFragment();t.forEach(s=>{const a=vt(s.completedAt),n=f(a),r=s.score>=80?"text-green-600":s.score>=60?"text-yellow-600":"text-red-600",l=s.userName||"Utilisateur",i=f(l),c=f(s.module||"Module"),g=f(`${Number.isFinite(s.score)?s.score:0}%`),u=f(l.charAt(0).toUpperCase()),p=document.createElement("article");p.className="flex items-center justify-between p-3 hover:bg-slate-50 rounded-lg transition-colors",p.innerHTML=`
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-indigo-100 rounded-full flex items-center justify-center">
                    <span class="text-lg font-bold text-indigo-600">${u}</span>
                </div>
                <div>
        ...
        `,o.appendChild(p)}),e.replaceChildren(o)}function it(){lt(),ct(),dt()}async function lt(){const t=document.getElementById("chart-progress");if(t)try{let e,o,s;if(w()){d.info("📈 Mode démo : Création graphique progression simulé..."),e=[],o=[],s=[];for(let r=29;r>=0;r--){const l=new Date;l.setDate(l.getDate()-r),e.push(l.toLocaleDateString("fr-FR",{day:"2-digit",month:"short"})),o.push(Math.floor(Math.random()*15)+5),s.push(Math.floor(Math.random()*20)+70)}}else{const r=new Date;r.setDate(r.getDate()-30);const l=await M(C(T,"quizResults")),i={};for(let c=0;c<30;c++){const g=new Date;g.setDate(g.getDate()-c);const u=g.toISOString().split("T")[0];i[u]={count:0,totalScore:0}}l.forEach(c=>{const g=c.data(),u=g.completedAt?.toDate();if(u&&u>=r){const p=u.toISOString().split("T")[0];i[p]&&(i[p].count++,i[p].totalScore+=g.score||0)}}),e=Object.keys(i).reverse().map(c=>new Date(c).toLocaleDateString("fr-FR",{day:"2-digit",month:"short"})),o=Object.values(i).reverse().map(c=>c.count),s=Object.values(i).reverse().map(c=>c.count>0?Math.round(c.totalScore/c.count):0)}const a=x.get("chartProgress");a&&a.destroy();const n=new Chart(t,{type:"line",data:{labels:e,datasets:[{label:"Quiz complétés",data:o,borderColor:"rgb(99, 102, 241)",backgroundColor:"rgba(99, 102, 241, 0.1)",tension:.4,yAxisID:"y"},{label:"Score moyen (%)",data:s,borderColor:"rgb(34, 197, 94)",backgroundColor:"rgba(34, 197, 94, 0.1)",tension:.4,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},scales:{y:{type:"linear",display:!0,position:"left",title:{display:!0,text:"Nombre de quiz"}},y1:{type:"linear",display:!0,position:"right",title:{display:!0,text:"Score moyen (%)"},grid:{drawOnChartArea:!1}}},plugins:{legend:{position:"top"},title:{display:!0,text:"Évolution sur 30 jours"}}}});x.set("chartProgress",n)}catch(e){d.error("❌ Erreur création graphique progression:",e)}}async function ct(){const t=document.getElementById("chart-modules");if(t)try{const e=await ce(),o=Object.keys(e),s=Object.values(e).map(l=>l.count),a=["rgba(99, 102, 241, 0.8)","rgba(34, 197, 94, 0.8)","rgba(251, 146, 60, 0.8)","rgba(236, 72, 153, 0.8)","rgba(14, 165, 233, 0.8)"],n=x.get("chartModules");n&&n.destroy();const r=new Chart(t,{type:"doughnut",data:{labels:o,datasets:[{data:s,backgroundColor:a,borderWidth:2,borderColor:"#fff"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom"},title:{display:!0,text:"Répartition par module"}}}});x.set("chartModules",r)}catch(e){d.error("❌ Erreur création graphique modules:",e)}}async function dt(){const t=document.getElementById("chart-activity");if(t)try{const e=[],o=[];for(let n=6;n>=0;n--){const r=new Date;r.setDate(r.getDate()-n),e.push(r.toLocaleDateString("fr-FR",{weekday:"short"})),o.push(Math.floor(Math.random()*20)+5)}const s=x.get("chartActivity");s&&s.destroy();const a=new Chart(t,{type:"bar",data:{labels:e,datasets:[{label:"Utilisateurs actifs",data:o,backgroundColor:"rgba(99, 102, 241, 0.8)",borderColor:"rgb(99, 102, 241)",borderWidth:1}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},title:{display:!0,text:"Activité des 7 derniers jours"}},scales:{y:{beginAtZero:!0,ticks:{stepSize:5}}}}});x.set("chartActivity",a)}catch(e){d.error("❌ Erreur création graphique activité:",e)}}async function ut(){const t=m.showLoadingToast("Génération du PDF...");try{const{jsPDF:e}=window.jspdf,o=new e;o.setFontSize(20),o.text("Dashboard Admin - QuizPro",20,20),o.setFontSize(10),o.text(`Généré le ${new Date().toLocaleDateString("fr-FR")}`,20,30),o.setFontSize(14),o.text("Statistiques Globales",20,45),o.setFontSize(10);let s=55;o.text(`Total Utilisateurs: ${globalStats.totalUsers}`,25,s),s+=7,o.text(`Total Quiz: ${globalStats.totalQuizzes}`,25,s),s+=7,o.text(`Score Moyen: ${globalStats.avgScore}%`,25,s),s+=7,o.text(`Questions: ${globalStats.totalQuestions}`,25,s),s+=7,o.text(`Ressources: ${globalStats.totalResources}`,25,s),o.save(`dashboard-admin-${new Date().toISOString().split("T")[0]}.pdf`),m.updateLoadingToast(t,"PDF généré avec succès !","success")}catch(e){d.error("❌ Erreur export PDF:",e),m.updateLoadingToast(t,"Erreur d'export PDF","error"),m.error("Erreur: Assurez-vous que jsPDF est chargé",4e3)}}async function mt(){const t=m.showLoadingToast("Génération du CSV...");try{const e=await M(C(T,"quizResults")),o=["Date","Utilisateur","Module","Mois","Année","Score (%)","Bonnes réponses","Total questions","Temps (s)"],s=[];e.forEach(l=>{const i=l.data(),c=i.completedAt?.toDate().toLocaleString("fr-FR")||"N/A";s.push([c,i.userName||"Inconnu",i.module||"N/A",i.month||"N/A",i.year||"N/A",i.score||0,i.correctAnswers||0,i.totalQuestions||0,i.timeSpent||0])});const a=[o,...s].map(l=>l.join(",")).join(`
`),n=new Blob([a],{type:"text/csv;charset=utf-8;"}),r=document.createElement("a");r.href=URL.createObjectURL(n),r.download=`dashboard-complet-${new Date().toISOString().split("T")[0]}.csv`,r.click(),m.updateLoadingToast(t,"CSV généré avec succès !","success")}catch(e){d.error("❌ Erreur export CSV:",e),m.updateLoadingToast(t,"Erreur d'export CSV","error"),m.error("Erreur lors de l'export CSV",4e3)}}function pt(){document.getElementById("export-pdf-btn")?.addEventListener("click",ut),document.getElementById("export-csv-btn")?.addEventListener("click",mt),document.getElementById("period-filter")?.addEventListener("change",gt),document.getElementById("refresh-dashboard-btn")?.addEventListener("click",()=>{m.info("Actualisation du dashboard...",2e3),le()})}async function gt(t){const e=t.target.value;m.info(`Filtrage: ${e}`,2e3)}function ht(){document.getElementById("global-stats-cards")&&I("global-stats-cards",we(4)),document.getElementById("top-users-list")&&I("top-users-list",W(10)),document.getElementById("recent-activity-list")&&I("recent-activity-list",W(8));const s=document.getElementById("progress-chart");s&&(s.innerHTML=j());const a=document.getElementById("modules-chart");a&&(a.innerHTML=j());const n=document.getElementById("activity-chart");n&&(n.innerHTML=j())}function vt(t){const o=new Date-t,s=Math.floor(o/1e3),a=Math.floor(s/60),n=Math.floor(a/60),r=Math.floor(n/24);return r>0?`Il y a ${r}j`:n>0?`Il y a ${n}h`:a>0?`Il y a ${a}min`:"À l'instant"}Me().then(t=>{console.log("Admin authentifié:",t.email),m.success(`Bienvenue ${t.displayName||t.email} !`,3e3);const e=document.getElementById("admin-name"),o=document.getElementById("admin-avatar");e&&(e.textContent=t.displayName||t.email),o&&t.photoURL&&(o.src=t.photoURL),le(),ze(),Ve(),ft()}).catch(t=>{console.error("Erreur authentification admin:",t)});function ft(){const t=document.getElementById("tab-dashboard-btn"),e=document.getElementById("tab-questions-btn"),o=document.getElementById("tab-users-btn"),s=document.getElementById("tab-dashboard"),a=document.getElementById("tab-questions"),n=document.getElementById("tab-users");function r(l,i){[t,e,o].forEach(c=>{c.classList.remove("border-indigo-600","text-indigo-600"),c.classList.add("border-transparent","text-slate-600"),c.setAttribute("aria-selected","false")}),[s,a,n].forEach(c=>{c.classList.add("tab-hidden")}),l.classList.remove("border-transparent","text-slate-600"),l.classList.add("border-indigo-600","text-indigo-600"),l.setAttribute("aria-selected","true"),i.classList.remove("tab-hidden")}t.addEventListener("click",()=>r(t,s)),e.addEventListener("click",()=>r(e,a)),o.addEventListener("click",()=>r(o,n))}document.getElementById("signout-link")?.addEventListener("click",t=>{t.preventDefault(),confirm("Voulez-vous vraiment vous déconnecter ?")&&ve().then(()=>{window.location.href="/"})});
//# sourceMappingURL=admin-BJlFR40K.js.map
