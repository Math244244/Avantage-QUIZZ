import{s as N,a as G,u as z,t as b,i as D,d as P,g as Y,b as te,c as oe,o as ne,e as re,f as se,h as ie,j as ae}from"./auth-VsLOkEMq.js";import{query as R,collection as H,where as k,getDocs as U}from"https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/10.7.1/firebase-auth.js";import"https://www.gstatic.com/firebasejs/10.7.1/firebase-database.js";console.log("Initialisation de la page d accueil...");document.addEventListener("DOMContentLoaded",le);function le(){console.log("📄 DOM chargé - configuration du bouton de connexion...");const e=document.getElementById("google-signin-btn");e?(e.addEventListener("click",de),console.log("✅ Bouton Google configuré")):console.warn("⚠️ Bouton Google non trouvé")}async function de(){console.log("🔐 Clic sur connexion Google...");const e=N("Connexion en cours...");try{const t=await G();z(e,`Bienvenue ${t.displayName} !`,"success"),setTimeout(()=>{window.location.reload()},800)}catch(t){console.error("❌ Erreur connexion Google:",t);let o="Erreur lors de la connexion";t.code==="auth/popup-closed-by-user"?o="Connexion annulée":t.code==="auth/popup-blocked"?o="Pop-up bloquée. Autorisez les pop-ups.":t.code==="auth/unauthorized-domain"?o="Domaine non autorisé dans Firebase":t.code==="auth/network-request-failed"&&(o="Erreur réseau. Vérifiez votre connexion."),z(e,o,"error")}}function ce(){const e=document.createElement("canvas");e.style.position="fixed",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.pointerEvents="none",e.style.zIndex="9999",document.body.appendChild(e);const t=e.getContext("2d");e.width=window.innerWidth,e.height=window.innerHeight;const o=[],n=["#FF6B6B","#4ECDC4","#45B7D1","#FFA07A","#98D8C8","#F7DC6F","#BB8FCE","#85C1E2"];for(let s=0;s<150;s++)o.push({x:Math.random()*e.width,y:e.height+Math.random()*100,size:Math.random()*8+4,speedY:-(Math.random()*3+3),speedX:Math.random()*6-3,color:n[Math.floor(Math.random()*n.length)],rotation:Math.random()*360,rotationSpeed:Math.random()*10-5,gravity:.15,opacity:1});function r(){t.clearRect(0,0,e.width,e.height);let s=0;o.forEach((i,a)=>{i.speedY+=i.gravity,i.y+=i.speedY,i.x+=i.speedX,i.rotation+=i.rotationSpeed,i.y>e.height-100&&(i.opacity-=.02),i.opacity>0&&i.y<e.height+50&&(s++,t.save(),t.translate(i.x,i.y),t.rotate(i.rotation*Math.PI/180),t.globalAlpha=i.opacity,t.fillStyle=i.color,t.fillRect(-i.size/2,-i.size/2,i.size,i.size),t.restore())}),s>0?requestAnimationFrame(r):e.remove()}r()}const Z={auto:{name:"AT-AVE-AVEX",color:"indigo",label:"Auto"},loisir:{name:"VTT, Motoneige, etc.",color:"cyan",label:"Loisir"},vr:{name:"Véhicules Récréatifs",color:"orange",label:"VR"},tracteur:{name:"Équipement Agricole",color:"green",label:"Tracteur"}};let d=null,h=0,u=[],A=null,L=null,S=null,T=0,v=!1,C=0,g=null,q=null,E=null,B=null,$=!1,F=!1;const j={indigo:{bg:"bg-indigo-600",text:"text-indigo-600",border:"border-indigo-600"},cyan:{bg:"bg-cyan-600",text:"text-cyan-600",border:"border-cyan-600"},orange:{bg:"bg-orange-600",text:"text-orange-600",border:"border-orange-600"},green:{bg:"bg-green-600",text:"text-green-600",border:"border-green-600"}};async function ue(e,t,o){console.log(`📥 Chargement des questions: module=${e}, mois=${t}, année=${o}`);const n=r=>{const s=r.data();return{id:r.id,question:s.question,options:s.options.map((i,a)=>({id:String.fromCharCode(65+a),text:i,correct:a===s.correctAnswer})),explanation:s.explanation||"Pas d'explication disponible",reference:s.reference||"",tags:s.tags||[]}};if(D()){console.log("📝 Mode démo : Chargement des questions simulées pour le quiz...");const s=localStorage.getItem("avantage-quizz-demo-questions");let i=[];if(s)try{const a=JSON.parse(s);console.log(`💾 ${a.length} questions chargées depuis localStorage`),i=a.map(l=>({id:l.id,question:l.question,options:l.options.map((x,c)=>({id:String.fromCharCode(65+c),text:x,correct:c===l.correctAnswer})),explanation:l.explanation||"Pas d'explication disponible",reference:l.reference||"",tags:l.tags||[]})),i=i.filter(l=>{const x=!e||a.find(f=>f.id===l.id)?.module===e,c=!t||a.find(f=>f.id===l.id)?.month===t;return x&&c})}catch{console.warn("⚠️ Erreur lecture localStorage, utilisation questions par défaut")}return i.length===0&&(console.log("📦 Utilisation questions par défaut (aucune en localStorage)"),i=[{id:"demo-1",question:"Quelle est la vitesse maximale autorisée sur une autoroute au Québec ?",options:[{id:"A",text:"100 km/h",correct:!1},{id:"B",text:"110 km/h",correct:!1},{id:"C",text:"120 km/h",correct:!1},{id:"D",text:"100 km/h (conditions normales)",correct:!0}],explanation:"La vitesse maximale sur autoroute au Québec est de 100 km/h, sauf indication contraire.",reference:"Code de la sécurité routière du Québec",tags:["vitesse","autoroute"]},{id:"demo-2",question:"À quelle distance minimale devez-vous vous arrêter derrière un autobus scolaire dont les feux clignotent ?",options:[{id:"A",text:"3 mètres",correct:!1},{id:"B",text:"5 mètres",correct:!0},{id:"C",text:"10 mètres",correct:!1},{id:"D",text:"15 mètres",correct:!1}],explanation:"Vous devez vous arrêter à au moins 5 mètres d'un autobus scolaire.",reference:"Article 460 CSR",tags:["autobus","sécurité"]},{id:"demo-3",question:"Quel est le taux d'alcoolémie maximal pour conduire au Québec ?",options:[{id:"A",text:"0.05",correct:!1},{id:"B",text:"0.08",correct:!0},{id:"C",text:"0.10",correct:!1},{id:"D",text:"0.00",correct:!1}],explanation:"Le taux maximal est de 0.08 pour conducteurs expérimentés.",reference:"Code criminel du Canada",tags:["alcool","sécurité"]},{id:"demo-4",question:"Combien de points d'inaptitude entraîne un excès de vitesse de 30 km/h ?",options:[{id:"A",text:"2 points",correct:!1},{id:"B",text:"3 points",correct:!0},{id:"C",text:"4 points",correct:!1},{id:"D",text:"5 points",correct:!1}],explanation:"Un excès de 21 à 30 km/h entraîne 3 points.",reference:"SAAQ",tags:["vitesse","points"]},{id:"demo-5",question:"Quelle est la distance de sécurité recommandée entre véhicules ?",options:[{id:"A",text:"1 seconde",correct:!1},{id:"B",text:"2 secondes",correct:!0},{id:"C",text:"3 secondes",correct:!1},{id:"D",text:"5 secondes",correct:!1}],explanation:"La règle des 2 secondes est recommandée.",reference:"Guide SAAQ",tags:["distance","sécurité"]}]),console.log(`✅ ${i.length} questions démo chargées pour le quiz`),i}try{let r=R(H(P,"questions"),k("module","==",e),k("month","==",t),k("year","==",o)),s=await U(r);if(!s.empty){const c=[];return s.forEach(f=>c.push(n(f))),console.log(`✅ ${c.length} questions (mois numérique)`),c}const a=["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"][t-1],l=a.charAt(0).toUpperCase()+a.slice(1).toLowerCase();let x=R(H(P,"questions"),k("module","==",e),k("month","==",l),k("year","==",o));if(s=await U(x),!s.empty){const c=[];return s.forEach(f=>c.push(n(f))),console.log(`✅ ${c.length} questions (mois texte)`),c}return console.warn("⚠️ Aucune question trouvée pour ces critères (numérique/texte)"),[]}catch(r){throw console.error("❌ Erreur lors du chargement des questions:",r),r}}async function me(e,t,o){try{const n=await fetch("/test-questions-valides.json");if(!n.ok)return[];const r=await n.json(),i=["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"][t-1];return r.filter(l=>l.module===e&&l.year===o&&(l.month===i||l.month===t)).map((l,x)=>({id:`demo-${e}-${x}`,question:l.question,options:l.options.map((c,f)=>({id:String.fromCharCode(65+f),text:c,correct:f===l.correctAnswer})),explanation:l.explanation||"Pas d'explication disponible",reference:l.reference||"",tags:l.tags||[]}))}catch(n){return console.warn("Demo questions fallback error:",n),[]}}async function W(e){const t=Z[e];if(!t){console.error("Module de quiz non trouvé:",e),b.error("Module non trouvé. Veuillez réessayer.");return}const o=N(`Chargement du quiz ${t.label}...`);ge(t.label);try{const n=new Date,r=["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"],s=n.getMonth()+1;E=r[s-1],B=n.getFullYear(),q=e;try{window.__QUIZ_ACTIVE=!0}catch{}let i=await ue(e,s,B);if(i.length===0&&D()&&(console.log("ℹ️ Mode Démo: chargement des questions locales de test"),i=await me(e,s,B)),i.length===0){z(o,"Aucune question disponible","error"),b.error(`Aucune question trouvée pour ${t.label} en ${E} ${B}.

Contactez l'administrateur.`,5e3);return}d={name:`Quiz ${t.label} - ${E.charAt(0).toUpperCase()+E.slice(1)}`,module:t.name,color:t.color,questions:i},h=0,u=[],A=Date.now(),S=Date.now(),T=0,v=!1,C=0,g=null,$=!1,fe(),K(),ye(),V(),z(o,`${i.length} questions chargées !`,"success")}catch(n){console.error("❌ Erreur lors du démarrage du quiz:",n),z(o,"Erreur de chargement","error"),b.error("Erreur lors du chargement du quiz. Veuillez réessayer.",4e3)}}function ge(e){const t=J();t.innerHTML=`
    ...
    `,t.classList.remove("view-hidden")}function fe(){document.getElementById("dashboard-view")?.classList.add("view-hidden"),document.getElementById("module-selection-view")?.classList.add("view-hidden"),document.getElementById("login-view")?.classList.add("view-hidden"),J().classList.remove("view-hidden")}function J(){let e=document.getElementById("quiz-view");return e||(e=document.createElement("div"),e.id="quiz-view",document.querySelector("main").appendChild(e)),pe(e),e}function pe(e){F||!e||(e.addEventListener("click",t=>{const o=t.target.closest(".option-button");if(o&&!o.disabled){const a=o.dataset.optionId;a&&he(a);return}if(t.target.closest("#next-question-btn")){t.preventDefault(),xe();return}if(t.target.closest("#quit-quiz-btn")){t.preventDefault(),confirm("Voulez-vous vraiment quitter le quiz ? Votre progression sera perdue.")&&X();return}if(t.target.closest("#focus-mode-btn")){t.preventDefault(),ke();return}if(t.target.closest("#pause-btn")){t.preventDefault(),Ce();return}}),F=!0)}function K(){const e=d.questions[h],t=document.getElementById("quiz-view"),o=j[d.color];$=!1,t.innerHTML=`
        <!-- En-tête du quiz -->
            ...
            <div class="max-w-5xl mx-auto px-6 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-slate-500">Question ${h+1} sur ${d.questions.length}</p>
                    </div>
                ...
                <div class="mt-4 w-full bg-gray-200 rounded-full h-2">
                    <div class="${o.bg} h-2 rounded-full transition-all duration-300" style="width: ${(h+1)/d.questions.length*100}%"></div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-5xl mx-auto px-6 py-8">
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="px-8 py-6 bg-gradient-to-r from-slate-50 to-white border-b border-gray-100">
                    <div class="mb-4">
                        <span class="text-sm font-medium ${o.text}">Question ${h+1} sur ${d.questions.length}</span>
                    </div>
    ...
    `,V()}function he(e){if($)return;const t=d.questions[h],o=t.options.find(r=>r.id===e),n=Math.floor((Date.now()-S)/1e3);$=!0,u.push({questionId:t.id,question:t.question,selectedAnswer:e,correctAnswer:t.options.find(r=>r.correct).id,isCorrect:o.correct,timeSpent:n}),o.correct?T++:T=0,document.querySelectorAll(".option-button").forEach(r=>{r.disabled=!0,r.classList.remove("hover:border-indigo-400","hover:bg-indigo-50")}),ve(e,o.correct,t),V(),setTimeout(()=>{document.getElementById("next-button-area")?.classList.remove("hidden")},1e3)}function ve(e,t,o){j[d.color];const n=o.options.find(s=>s.correct);document.querySelectorAll(".option-button").forEach(s=>{const i=s.dataset.optionId;i===n.id?(s.classList.add("border-green-500","bg-green-50"),s.classList.remove("border-gray-200")):i===e&&!t&&(s.classList.add("border-red-500","bg-red-50"),s.classList.remove("border-gray-200"))});const r=document.getElementById("explanation-area");r&&(r.innerHTML=`
        ...
        `,r.classList.remove("hidden"))}function xe(){S=Date.now(),h++,h<d.questions.length?K():be()}function be(){Q();try{window.__QUIZ_ACTIVE=!1}catch{}const e=Math.round(u.filter(a=>a.isCorrect).length/u.length*100);let t=C;v&&g&&(t+=Date.now()-g);const o=Math.max(0,Math.floor((Date.now()-A-t)/1e3));v=!1,g=null,C=0;const n=Math.floor(o/60),r=o%60;we(e,o);const s=j[d.color],i=document.getElementById("quiz-view");i.innerHTML=`
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-3xl shadow-2xl overflow-hidden mb-8">
                    ...
                    <div class="bg-gradient-to-r from-${d.color}-500 to-${d.color}-700 px-8 py-12 text-center text-white">
                        ...
                        <p class="text-xl opacity-90">${u.filter(a=>a.isCorrect).length} / ${u.length} bonnes réponses</p>
                        <p class="text-lg opacity-75 mt-2">Temps total : ${n}:${r.toString().padStart(2,"0")}</p>
                    </div>
                    ...
                    <div class="px-8 py-6">
                        ...
                        <div class="space-y-3 max-h-96 overflow-y-auto">
                            ${u.map((a,l)=>`
                                <div class="flex items-center justify-between p-4 rounded-lg ${a.isCorrect?"bg-green-50":"bg-red-50"}">
                                    <div class="flex items-center gap-3 flex-1">
                                        <span class="${a.isCorrect?"text-green-600":"text-red-600"} text-2xl">
                                            ${a.isCorrect?"✅":"❌"}
                                        </span>
                                        <div class="flex-1">
                                            <p class="font-medium text-slate-900">Question ${l+1}</p>
                                            <p class="text-sm text-slate-600">${a.question}</p>
                                            ${a.isCorrect?"":`<p class="text-xs text-slate-500 mt-1">Votre réponse : ${a.selectedAnswer} | Correcte : ${a.correctAnswer}</p>`}
                                        </div>
                                    </div>
                                    <span class="text-sm text-slate-500">${a.timeSpent}s</span>
                                </div>
                            `).join("")}
                        </div>
                    </div>
    ...
    `,e>=80&&setTimeout(()=>ce(),500),document.getElementById("retry-quiz-btn")?.addEventListener("click",()=>{W(q)}),document.getElementById("return-dashboard-btn")?.addEventListener("click",X)}async function we(e,t){try{if(!Y()){console.log("Aucun utilisateur - résultat non sauvegardé");return}if(D()){console.log("Mode démo - résultat non sauvegardé dans Firestore"),b.info("Mode Démo : les résultats ne sont pas sauvegardés");return}const n=Z[q]||{};await te({moduleId:q,moduleName:n.name||d.module||q,score:e,correctAnswers:u.filter(r=>r.isCorrect).length,totalQuestions:d.questions.length,timeElapsed:t,answers:u,month:E,year:B}),console.log("✅ Résultat sauvegardé dans Firestore")}catch(o){console.error("❌ Erreur lors de la sauvegarde:",o)}}function ye(){Q(),L=setInterval(()=>{if(A===null)return;let e=C;v&&g&&(e+=Date.now()-g);const t=Date.now()-A-e,o=Math.max(0,Math.floor(t/1e3)),n=Math.floor(o/60),r=o%60,s=document.getElementById("quiz-timer");s&&(s.textContent=`${n}:${r.toString().padStart(2,"0")}`)},1e3)}function Q(){L&&(clearInterval(L),L=null),g=null}function V(){if(u.length===0)return;const e=Math.round(u.filter(o=>o.isCorrect).length/u.length*100),t=document.getElementById("quiz-score");t&&(t.textContent=`Score: ${e}%`)}function ke(){document.body.classList.toggle("focus-mode")}function Ce(){const e=document.getElementById("pause-btn");e&&(v?(v=!1,g&&(C+=Date.now()-g),g=null,e.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> Pause',b.success("Quiz repris !",2e3)):(v=!0,g=Date.now(),e.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> Reprendre',b.warning('Quiz en pause. Cliquez sur "Reprendre" pour continuer.',3e3)))}function X(){Q();try{window.__QUIZ_ACTIVE=!1}catch{}v=!1,C=0,g=null,$=!1,document.getElementById("quiz-view")?.classList.add("view-hidden"),document.getElementById("dashboard-view")?.classList.remove("view-hidden"),document.querySelectorAll(".nav-link").forEach(e=>{e.classList.remove("bg-indigo-800","text-indigo-100"),e.classList.add("text-indigo-300")}),document.getElementById("nav-dashboard")?.classList.add("bg-indigo-800","text-indigo-100"),b.info("Retour au tableau de bord",2e3),setTimeout(()=>window.location.reload(),500)}const y=10,Ee=["Janvier","Février","Mars","Avril","Mai","Juin","Juillet","Août","Septembre","Octobre","Novembre","Décembre"];let p=Ee.map(e=>({name:e,score:null}));const I={login:document.getElementById("login-view"),dashboard:document.getElementById("dashboard-view"),moduleSelection:document.getElementById("module-selection-view")},m={modulesGrid:document.getElementById("modules-grid"),annualProgressBar:document.getElementById("annual-progress-bar"),annualProgressText:document.getElementById("annual-progress-text"),moduleSelectionTitle:document.getElementById("module-selection-title"),welcomeMessage:document.getElementById("welcome-message"),userAvatar:document.getElementById("user-avatar"),userName:document.getElementById("user-name"),googleSigninBtn:document.getElementById("google-signin-btn"),signoutLink:document.getElementById("signout-link")};let _=!1;function w(e){Object.values(I).forEach(t=>{t&&t.classList.add("view-hidden")}),I[e]?I[e].classList.remove("view-hidden"):console.error("❌ Vue non trouvée:",e)}function M(e){document.querySelectorAll(".nav-link").forEach(o=>{o.classList.remove("bg-indigo-800","text-indigo-100"),o.classList.add("text-indigo-300")});const t=document.getElementById(e);t&&(t.classList.add("bg-indigo-800","text-indigo-100"),t.classList.remove("text-indigo-300"))}function Be(e){const o=108*Math.PI,n=o-e/100*o;let r="text-green-600";return e<80&&(r="text-yellow-500"),e<60&&(r="text-red-600"),`
    ...
    `}function ze(e,t){const n=(r=>r>=90?{bg:"from-indigo-600 via-indigo-700 to-indigo-800",badge:"bg-emerald-500",badgeText:"Excellent"}:r>=75?{bg:"from-indigo-500 via-indigo-600 to-indigo-700",badge:"bg-blue-500",badgeText:"Très bien"}:r>=60?{bg:"from-indigo-400 via-indigo-500 to-indigo-600",badge:"bg-indigo-400",badgeText:"Bien"}:{bg:"from-slate-400 via-slate-500 to-slate-600",badge:"bg-slate-400",badgeText:"Passable"})(t);return`
    ...
    `}function Le(){let e=0;for(let t=y-1;t>=0&&(p[t].score!==null&&p[t].score>=60);t--)e++;return e}async function Ae(){try{const e=Y();if(!e){console.log("ℹ️ Aucun utilisateur - pas de données à charger");return}console.log("📊 Chargement des données du dashboard...");const t=await re(e.uid);t&&await se(t);const o=await ie(e.uid);p=p.map((s,i)=>{const a=`${s.name} ${new Date().getFullYear()}`;return o[a]?{name:s.name,score:o[a].score}:s});const n=await ae(e.uid),r=document.getElementById("streak-count");r&&(r.textContent=n),console.log("✅ Données du dashboard chargées")}catch(e){console.error("❌ Erreur chargement données:",e)}}async function Ie(){if(!m.modulesGrid){console.error("❌ L'élément 'modules-grid' est introuvable.");return}await Ae(),m.modulesGrid.innerHTML="";let e=0;p.forEach((s,i)=>{let a="";i<y?s.score!==null?(a=ze(s.name,s.score),e++):a=$e(s.name):i===y?a=Me(s.name):a=qe(s.name),m.modulesGrid.innerHTML+=a});const t=e/12*100;m.annualProgressBar.style.width=`${t}%`,m.annualProgressText.textContent=`${e}/12`;const o=Le(),n=document.getElementById("streak-count");n&&(n.textContent=o);const r=document.getElementById("streak-badge");r&&o===0&&(r.style.display="none"),Qe(),setTimeout(()=>{Te(),De(),Se()},500)}function Te(){const e=document.getElementById("skills-radar-chart");e&&new Chart(e,{type:"radar",data:{labels:["Procédures","Garanties","Documentation","Inspection","Entretien","Réglementation"],datasets:[{label:"Vos Compétences",data:[92,88,85,90,87,94],backgroundColor:"rgba(99, 102, 241, 0.2)",borderColor:"rgb(99, 102, 241)",borderWidth:2,pointBackgroundColor:"rgb(99, 102, 241)",pointBorderColor:"#fff",pointHoverBackgroundColor:"#fff",pointHoverBorderColor:"rgb(99, 102, 241)"}]},options:{responsive:!0,maintainAspectRatio:!0,scales:{r:{beginAtZero:!0,max:100,ticks:{stepSize:20}}},plugins:{legend:{display:!1}}}})}function De(){const e=document.getElementById("scores-trend-chart");if(!e)return;const t=p.filter((o,n)=>n<y);new Chart(e,{type:"line",data:{labels:t.map(o=>o.name),datasets:[{label:"Score (%)",data:t.map(o=>o.score),backgroundColor:"rgba(99, 102, 241, 0.1)",borderColor:"rgb(99, 102, 241)",borderWidth:3,fill:!0,tension:.4,pointRadius:5,pointHoverRadius:7,pointBackgroundColor:"rgb(99, 102, 241)",pointBorderColor:"#fff",pointBorderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!0,scales:{y:{beginAtZero:!0,max:100,ticks:{callback:function(o){return o+"%"}}}},plugins:{legend:{display:!1},tooltip:{callbacks:{label:function(o){return"Score: "+o.parsed.y+"%"}}}}}})}function Se(){const e=document.getElementById("activity-heatmap");if(!e)return;const t=52,o=7;let n='<div class="flex gap-1">';for(let r=0;r<t;r++){n+='<div class="flex flex-col gap-1">';for(let s=0;s<o;s++){const i=r*o+s;let a=0;i%30<28&&(a=Math.floor(Math.random()*4)+1),n+=`<div class="w-3 h-3 rounded-sm ${["bg-slate-100","bg-green-200","bg-green-400","bg-green-600","bg-green-800"][a]}" title="Activité"></div>`}n+="</div>"}n+="</div>",e.innerHTML=n}let O=!1;function je(){O||(O=!0,console.log("🔧 Attachement des listeners de navigation (une seule fois)..."),document.getElementById("nav-dashboard")?.addEventListener("click",e=>{e.preventDefault(),w("dashboard"),M("nav-dashboard")}),document.getElementById("nav-quiz")?.addEventListener("click",e=>{e.preventDefault();const t=p[y].name;m.moduleSelectionTitle.textContent=`Quiz de ${t}`,w("moduleSelection"),M("nav-quiz")}),document.getElementById("nav-results")?.addEventListener("click",e=>{e.preventDefault();const t=e.currentTarget;window.__QUIZ_ACTIVE?confirm("Un quiz est en cours. Voulez-vous vraiment quitter ?")&&t&&t.href&&(window.location.href=t.href):t&&t.href&&(window.location.href=t.href)}),document.getElementById("nav-resources")?.addEventListener("click",e=>{e.preventDefault();const t=e.currentTarget;window.__QUIZ_ACTIVE?confirm("Un quiz est en cours. Voulez-vous vraiment quitter ?")&&t&&t.href&&(window.location.href=t.href):t&&t.href&&(window.location.href=t.href)}),console.log("✅ Listeners de navigation attachés"))}function Qe(){_||(document.addEventListener("click",e=>{if(e.target.closest(".start-quiz-button")){e.preventDefault();const r=p[y].name;m.moduleSelectionTitle.textContent=`Quiz de ${r}`,w("moduleSelection"),M("nav-quiz");return}if(e.target.closest(".back-to-dashboard")){e.preventDefault(),w("dashboard"),M("nav-dashboard");return}const n=e.target.closest(".module-card");if(n){e.preventDefault();const r=n.getAttribute("data-module");r&&W(r)}}),_=!0)}function Ve(e){if(e){m.userName.textContent=e.displayName||"Utilisateur",m.userAvatar.src=e.photoURL||"https://placehold.co/100x100/667eea/e0e7ff?text="+(e.displayName?.[0]||"U");const t=e.displayName?.split(" ")[0]||"Utilisateur";m.welcomeMessage.textContent=`Bonjour ${t}, prêt à relever votre défi de ${p[y].name} ?`}}function Pe(){const e=localStorage.getItem("theme")||"light";document.documentElement.classList.toggle("dark",e==="dark"),ee(e)}function ee(e){const t=document.getElementById("theme-icon-sun"),o=document.getElementById("theme-icon-moon"),n=document.getElementById("theme-text");e==="dark"?(t?.classList.remove("hidden"),o?.classList.add("hidden"),n&&(n.textContent="Mode Clair")):(t?.classList.add("hidden"),o?.classList.remove("hidden"),n&&(n.textContent="Mode Sombre"))}function Re(){const t=(document.documentElement.classList.contains("dark")?"dark":"light")==="dark"?"light":"dark";document.documentElement.classList.toggle("dark"),localStorage.setItem("theme",t),ee(t)}document.addEventListener("DOMContentLoaded",()=>{console.log("🚀 Initialisation de QuizPro..."),Pe(),je(),document.getElementById("theme-toggle")?.addEventListener("click",Re),m.googleSigninBtn?.addEventListener("click",G),m.signoutLink?.addEventListener("click",e=>{e.preventDefault(),confirm("Voulez-vous vraiment vous déconnecter ?")&&oe()}),w("login"),ne(e=>{e?(console.log("✅ Utilisateur connecté:",e.displayName),Ve(e),w("dashboard"),M("nav-dashboard"),Ie()):(console.log("👤 Aucun utilisateur connecté"),w("login"))}),console.log("✅ QuizPro initialisé avec succès")});
//# sourceMappingURL=main-C_JOvGE9.js.map
