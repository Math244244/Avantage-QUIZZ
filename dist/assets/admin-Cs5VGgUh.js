import{i as g,m as ie,n as le,j as ce,p as de,q as ue,r as me,v as pe,w as ge,x as he,y as ve,t as d,z as fe,d as y,f as be}from"./auth-BBQLVo24.js";/* empty css               */import{s as z,c as xe,a as we,b as ye,d as q,e as J}from"./skeleton-DRQ05dn4.js";import{getDocs as E,collection as S,query as Ee,orderBy as Se,limit as Te}from"https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/10.7.1/firebase-auth.js";import"https://www.gstatic.com/firebasejs/10.7.1/firebase-database.js";class Ae{constructor(){this.activeTooltip=null,this.hoverDelay=300,this.hideDelay=100,this.hoverTimer=null,this.hideTimer=null,this.isTouchDevice="ontouchstart"in window,this.init()}init(){console.log("🎯 Initialisation du système de tooltips"),this.createTooltipContainer(),this.initializeTooltips(),this.observeDOM(),console.log("✅ Système de tooltips initialisé")}createTooltipContainer(){let e=document.getElementById("tooltip-container");e||(e=document.createElement("div"),e.id="tooltip-container",e.className="fixed pointer-events-none z-[9999]",document.body.appendChild(e)),this.container=e}initializeTooltips(){const e=document.querySelectorAll("[data-tooltip]");e.forEach(o=>this.attachTooltip(o)),console.log(`📌 ${e.length} tooltips initialisés`)}observeDOM(){new MutationObserver(o=>{o.forEach(s=>{s.addedNodes.forEach(a=>{a.nodeType===1&&(a.hasAttribute&&a.hasAttribute("data-tooltip")&&this.attachTooltip(a),a.querySelectorAll&&a.querySelectorAll("[data-tooltip]").forEach(n=>{this.attachTooltip(n)}))})})}).observe(document.body,{childList:!0,subtree:!0})}attachTooltip(e){e.dataset.tooltipAttached||(e.dataset.tooltipAttached="true",!this.isTouchDevice&&(e.addEventListener("mouseenter",o=>this.handleMouseEnter(o,e)),e.addEventListener("mouseleave",o=>this.handleMouseLeave(o)),e.addEventListener("focus",o=>this.handleFocus(o,e)),e.addEventListener("blur",o=>this.handleBlur(o)),e.setAttribute("aria-describedby",`tooltip-${this.generateId()}`)))}generateId(){return Math.random().toString(36).substring(2,11)}handleMouseEnter(e,o){clearTimeout(this.hideTimer),this.hoverTimer=setTimeout(()=>{this.showTooltip(o)},this.hoverDelay)}handleMouseLeave(e){clearTimeout(this.hoverTimer),this.hideTimer=setTimeout(()=>{this.hideTooltip()},this.hideDelay)}handleFocus(e,o){this.showTooltip(o)}handleBlur(e){this.hideTooltip()}showTooltip(e){const o=e.dataset.tooltip,s=e.dataset.tooltipPosition||"top",a=e.dataset.tooltipTheme||"dark",n=e.dataset.tooltipSize||"medium";if(!o)return;this.hideTooltip();const r=this.createTooltipElement(o,a,n);this.container.appendChild(r),this.activeTooltip=r,this.positionTooltip(r,e,s),setTimeout(()=>{r.classList.remove("opacity-0","scale-95"),r.classList.add("opacity-100","scale-100")},10)}createTooltipElement(e,o,s){const a=document.createElement("div");return a.className=`tooltip absolute opacity-0 scale-95 transform transition-all duration-200 ease-out ${this.getThemeClasses(o)} ${this.getSizeClasses(s)}`,a.innerHTML=`
        ...
        `,a}getThemeClasses(e){const o={dark:"bg-slate-900 text-white shadow-lg",light:"bg-white text-slate-900 shadow-lg border border-slate-200",success:"bg-green-600 text-white shadow-lg",error:"bg-red-600 text-white shadow-lg",warning:"bg-orange-600 text-white shadow-lg",info:"bg-blue-600 text-white shadow-lg"};return o[e]||o.dark}getSizeClasses(e){const o={small:"text-xs px-2 py-1 rounded",medium:"text-sm px-3 py-2 rounded-md",large:"text-base px-4 py-3 rounded-lg"};return o[e]||o.medium}getArrowClasses(e){const o={dark:"bg-slate-900",light:"bg-white border-l border-b border-slate-200",success:"bg-green-600",error:"bg-red-600",warning:"bg-orange-600",info:"bg-blue-600"};return o[e]||o.dark}positionTooltip(e,o,s){const a=o.getBoundingClientRect(),n=e.getBoundingClientRect(),r=e.querySelector(".tooltip-arrow"),i=8,l=8,u={top:{top:a.top-n.height-i,left:a.left+a.width/2-n.width/2,arrowTop:n.height-l/2,arrowLeft:n.width/2-l/2,arrowRotate:"rotate(45deg)"},bottom:{top:a.bottom+i,left:a.left+a.width/2-n.width/2,arrowTop:-l/2,arrowLeft:n.width/2-l/2,arrowRotate:"rotate(225deg)"},left:{top:a.top+a.height/2-n.height/2,left:a.left-n.width-i,arrowTop:n.height/2-l/2,arrowLeft:n.width-l/2,arrowRotate:"rotate(135deg)"},right:{top:a.top+a.height/2-n.height/2,left:a.right+i,arrowTop:n.height/2-l/2,arrowLeft:-l/2,arrowRotate:"rotate(315deg)"}};let w=s;const p=u[s];if(p&&(p.top<0||p.top+n.height>window.innerHeight||p.left<0||p.left+n.width>window.innerWidth)){const re=["top","bottom","left","right"];for(const V of re){const $=u[V];if(!($.top<0||$.top+n.height>window.innerHeight||$.left<0||$.left+n.width>window.innerWidth)){w=V;break}}}const m=u[w]||u.top;e.style.top=`${m.top}px`,e.style.left=`${m.left}px`,r&&(r.style.top=`${m.arrowTop}px`,r.style.left=`${m.arrowLeft}px`,r.style.transform=m.arrowRotate)}hideTooltip(){this.activeTooltip&&(this.activeTooltip.classList.remove("opacity-100","scale-100"),this.activeTooltip.classList.add("opacity-0","scale-95"),setTimeout(()=>{this.activeTooltip&&this.activeTooltip.parentNode&&this.activeTooltip.parentNode.removeChild(this.activeTooltip),this.activeTooltip=null},200))}add(e,o,s={}){e.dataset.tooltip=o,e.dataset.tooltipPosition=s.position||"top",e.dataset.tooltipTheme=s.theme||"dark",e.dataset.tooltipSize=s.size||"medium",this.attachTooltip(e)}remove(e){e.removeAttribute("data-tooltip"),e.removeAttribute("data-tooltip-position"),e.removeAttribute("data-tooltip-theme"),e.removeAttribute("data-tooltip-size"),e.removeAttribute("data-tooltip-attached"),e.removeAttribute("aria-describedby")}update(e,o,s={}){this.remove(e),this.add(e,o,s)}destroy(){this.container&&this.container.parentNode&&this.container.parentNode.removeChild(this.container),clearTimeout(this.hoverTimer),clearTimeout(this.hideTimer),console.log("🗑️ Système de tooltips détruit")}}const Le=new Ae;window.tooltip=Le;async function Me(){return new Promise((t,e)=>{if(g()){const s=ie();if(s&&s.role==="admin"){console.log("✅ Admin autorisé (mode démo):",s.email),t(s);return}else{console.warn("❌ Accès refusé: utilisateur démo non admin"),alert("Accès refusé. Cette page est réservée aux administrateurs."),window.location.href="/index.html",e(new Error("Non autorisé"));return}}const o=le.onAuthStateChanged(async s=>{if(o(),!s){console.warn("❌ Accès refusé: Utilisateur non connecté"),window.location.href="/index.html",e(new Error("Non authentifié"));return}try{const a=await ce(s.uid);if(!a||a.role!=="admin"){console.warn("❌ Accès refusé: Utilisateur non administrateur"),alert("Accès refusé. Cette page est réservée aux administrateurs."),window.location.href="/index.html",e(new Error("Non autorisé"));return}console.log("✅ Admin autorisé:",s.email),t(s)}catch(a){console.error("❌ Erreur vérification admin:",a),window.location.href="/index.html",e(a)}})})}const ee="avantage-quizz-demo-questions";function ze(){if(!g())return[];const t=localStorage.getItem(ee);if(t)try{return JSON.parse(t).map(o=>({...o,createdAt:new Date(o.createdAt)}))}catch(e){console.warn("⚠️ Erreur lecture questions démo:",e)}return[{id:"1",module:"auto",month:11,year:2025,question:"Quelle est la pression recommandée pour les pneus d'une voiture standard ?",options:["32 PSI","25 PSI","40 PSI","50 PSI"],correctAnswer:0,explanation:"La pression recommandée est généralement de 32 PSI pour un véhicule standard.",createdAt:new Date},{id:"2",module:"auto",month:11,year:2025,question:"À quelle fréquence doit-on changer l'huile moteur ?",options:["Tous les 5000 km","Tous les 10000 km","Tous les 15000 km","Tous les 20000 km"],correctAnswer:1,explanation:"Il est recommandé de changer l'huile tous les 10000 km ou selon les recommandations du fabricant.",createdAt:new Date},{id:"3",module:"loisir",month:11,year:2025,question:"Quel est le poids maximal recommandé pour un bateau remorqué ?",options:["1500 kg","2000 kg","2500 kg","3000 kg"],correctAnswer:2,explanation:"Pour un véhicule standard, 2500 kg est souvent la limite recommandée.",createdAt:new Date},{id:"4",module:"vr",month:10,year:2025,question:"Quelle est la capacité minimale recommandée pour une batterie de VR ?",options:["75 Ah","100 Ah","125 Ah","150 Ah"],correctAnswer:1,explanation:"Une batterie de 100 Ah est le minimum recommandé pour un VR.",createdAt:new Date},{id:"5",module:"tracteur",month:10,year:2025,question:"À quelle profondeur doit-on labourer pour les cultures céréalières ?",options:["10-15 cm","20-25 cm","30-35 cm","40-45 cm"],correctAnswer:1,explanation:"La profondeur idéale est de 20-25 cm pour les céréales.",createdAt:new Date}]}function F(t){g()&&(localStorage.setItem(ee,JSON.stringify(t)),console.log("💾 Questions démo sauvegardées:",t.length))}let T=ze();const $e={total:240,byModule:{auto:85,loisir:62,vr:54,tracteur:39},recent:12};let b=[],h={module:"",month:"",year:new Date().getFullYear()},x=1;const C=20;async function ke(){console.log("Initialisation du gestionnaire de questions"),await A(),await L(),Ce()}function Ce(){const t=document.getElementById("create-question-form");t&&t.addEventListener("submit",De);const e=document.getElementById("json-file-input");e&&e.addEventListener("change",Ie);const o=document.getElementById("browse-json-btn");o&&o.addEventListener("click",()=>e?.click());const s=document.getElementById("filter-module"),a=document.getElementById("filter-month"),n=document.getElementById("filter-year"),r=document.getElementById("search-questions");s&&s.addEventListener("change",N),a&&a.addEventListener("change",N),n&&n.addEventListener("change",N),r&&r.addEventListener("input",Ue);const i=document.getElementById("prev-page-btn"),l=document.getElementById("next-page-btn");i&&i.addEventListener("click",()=>W(-1)),l&&l.addEventListener("click",()=>W(1))}async function A(){try{if(document.getElementById("questions-list")&&z("questions-list",xe(5)),g()){console.log("📝 Mode démo : Chargement des questions simulées..."),await new Promise(o=>setTimeout(o,500)),b=T.filter(o=>!(h.module&&o.module!==h.module||h.month&&o.month!==parseInt(h.month)||h.year&&o.year!==parseInt(h.year))),console.log(`✅ ${b.length} questions simulées chargées`),D();return}const e={};h.module&&(e.module=h.module),h.month&&(e.month=parseInt(h.month)),h.year&&(e.year=parseInt(h.year)),b=await de(e),console.log(`Questions chargees: ${b.length}`),D()}catch(t){console.error("Erreur chargement questions:",t);const e=document.getElementById("questions-list");e&&(e.innerHTML=`
        ...
        `;return}const e=(x-1)*C,o=e+C,s=b.slice(e,o);t.innerHTML=s.map(a=>te(a)).join(""),He(),oe()}function te(t){const e={auto:"indigo",loisir:"cyan",vr:"orange",tracteur:"green"},o={auto:"🚗",loisir:"🏔️",vr:"🚐",tracteur:"🚜"},s=e[t.module]||"gray",a=o[t.module]||"📝",r=["Jan","Fev","Mar","Avr","Mai","Juin","Juil","Aout","Sep","Oct","Nov","Dec"][t.month-1]||t.month;return`
        <div class="question-card bg-white rounded-xl shadow-md p-6 mb-4 hover:shadow-lg transition-shadow" data-question-id="${t.id}">
            <div class="flex items-start justify-between mb-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="ml-2 text-sm text-slate-500">${r} ${t.year}</span>
                    </div>
                </div>
            ...
            <h4 class="text-lg font-semibold text-slate-900 mb-4">${k(t.question)}</h4>
            ...
            <div class="bg-blue-50 border-l-4 border-blue-500 p-3 rounded">
                ...
                <p class="text-sm text-blue-900">${k(t.explanation)}</p>
            </div>
            ...
            <div class="bg-white rounded-lg p-4 mb-4 max-h-60 overflow-y-auto">
                ...
                <ol class="space-y-2 text-sm text-slate-700">
                    ${t.questions.slice(0,5).map((n,r)=>`
                        <li><strong>${r+1}.</strong> ${k(n.question.substring(0,80))}${n.question.length>80?"...":""}</li>
                    `).join("")}
    ...
    `,document.getElementById("confirm-import-btn")?.addEventListener("click",()=>Ne(t)),document.getElementById("cancel-import-btn")?.addEventListener("click",()=>{o.innerHTML="",document.getElementById("json-file-input").value=""})}async function Ne(t){const e=document.getElementById("json-preview"),o=document.getElementById("confirm-import-btn");try{if(o.disabled=!0,o.innerHTML='<svg class="animate-spin h-5 w-5 inline" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle></svg> Import en cours...',g()){console.log("📝 Mode démo : Simulation import JSON..."),await new Promise(n=>setTimeout(n,1e3));const a=t.questions||[];a.forEach((n,r)=>{T.unshift({id:`demo-imported-${Date.now()}-${r}`,question:n.question,options:n.options,correctAnswer:n.correctAnswer,explanation:n.explanation||"Pas d'explication fournie",module:t.module,month:t.month,year:t.year,createdAt:new Date})}),F(T),M(`✅ Import terminé (mode démo): ${a.length} questions importées`),e.innerHTML="",document.getElementById("json-file-input").value="",await A(),await L();return}const s=await ge(t);M(`Import termine: ${s.success}/${s.total} questions importees`),s.errors.length>0&&console.warn("Erreurs import:",s.errors),e.innerHTML="",document.getElementById("json-file-input").value="",await A(),await L()}catch(s){console.error("Erreur import:",s),B("json-preview",s.message||"Erreur lors de l import")}}function je(t){b.find(o=>o.id===t)&&alert(`Edition de la question ${t}
A implementer: modal d'edition`)}async function Qe(t){const e=b.find(s=>s.id===t);if(!(!e||!confirm(`Voulez-vous vraiment supprimer cette question?

"${e.question.substring(0,100)}..."

Cette action est irreversible.`)))try{if(g()){console.log("📝 Mode démo : Simulation suppression question..."),await new Promise(a=>setTimeout(a,300));const s=T.findIndex(a=>a.id===t);s>-1&&(T.splice(s,1),F(T)),M("✅ Question supprimée avec succès (mode démo)"),await A(),await L();return}await pe(t),M("Question supprimee avec succes"),await A(),await L()}catch(s){console.error("Erreur suppression:",s),B("questions-list",s.message||"Erreur lors de la suppression")}}async function N(t){const e=t.target.id.replace("filter-","");h[e]=t.target.value,x=1,await A()}function Ue(t){const e=t.target.value.toLowerCase();if(!e){D();return}const o=b.filter(a=>a.question.toLowerCase().includes(e)||a.options.some(n=>n.toLowerCase().includes(e))||a.explanation.toLowerCase().includes(e)),s=document.getElementById("questions-list");if(s){if(o.length===0){s.innerHTML=`
            <div class="text-center py-12 text-slate-500">
                <p class="text-lg">Aucun resultat pour "${e}"</p>
            </div>
        `;return}s.innerHTML=o.map(a=>te(a)).join(""),oe()}}function W(t){const e=Math.ceil(b.length/C);x+=t,x<1&&(x=1),x>e&&(x=e),D(),window.scrollTo({top:0,behavior:"smooth"})}function He(){const t=Math.ceil(b.length/C),e=document.getElementById("page-info"),o=document.getElementById("prev-page-btn"),s=document.getElementById("next-page-btn");e&&(e.textContent=`Page ${x}/${t||1}`),o&&(o.disabled=x===1),s&&(s.disabled=x===t||t===0)}async function L(){try{if(g()){console.log("📊 Mode démo : Chargement des stats simulées..."),G($e);return}const t=await ue();G(t)}catch(t){console.error("Erreur chargement stats:",t)}}function G(t){const e=document.getElementById("questions-stats");if(!e)return;const o={auto:"Auto",loisir:"Loisir",vr:"VR",tracteur:"Tracteur"};e.innerHTML=`
    ...
    `,document.body.appendChild(e),setTimeout(()=>{e.remove()},3e3)}function k(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}const Fe=[{id:"1",email:"admin@avantage-quizz.com",displayName:"Administrateur Principal",role:"admin",totalQuizzes:0,averageScore:0,createdAt:new Date("2025-01-15"),lastLogin:new Date},{id:"2",email:"alice.dupont@example.com",displayName:"Alice Dupont",role:"user",totalQuizzes:24,averageScore:92,createdAt:new Date("2025-02-20"),lastLogin:new Date},{id:"3",email:"bob.martin@example.com",displayName:"Bob Martin",role:"user",totalQuizzes:21,averageScore:88,createdAt:new Date("2025-03-10"),lastLogin:new Date(Date.now()-864e5)},{id:"4",email:"claire.bernard@example.com",displayName:"Claire Bernard",role:"user",totalQuizzes:19,averageScore:85,createdAt:new Date("2025-03-25"),lastLogin:new Date(Date.now()-1728e5)},{id:"5",email:"david.dubois@example.com",displayName:"David Dubois",role:"user",totalQuizzes:18,averageScore:83,createdAt:new Date("2025-04-05"),lastLogin:new Date(Date.now()-2592e5)}],Pe={total:42,admins:2,regularUsers:40,activeToday:8,activeWeek:23};let v=[],f={role:"",status:"all"};async function Oe(){console.log("Initialisation du gestionnaire utilisateurs"),await P(),await se(),Ve()}function Ve(){const t=document.getElementById("create-user-form");t&&t.addEventListener("submit",Je);const e=document.getElementById("generate-password-btn");e&&e.addEventListener("click",We);const o=document.getElementById("filter-user-role"),s=document.getElementById("filter-user-status"),a=document.getElementById("search-users");o&&o.addEventListener("change",K),s&&s.addEventListener("change",K),a&&a.addEventListener("input",Xe)}async function Je(t){t.preventDefault();const e=document.getElementById("create-user-error"),o=document.getElementById("create-user-success"),s=document.getElementById("create-user-btn");e.classList.add("hidden"),o.classList.add("hidden");const a=new FormData(t.target),n={displayName:a.get("displayName"),email:a.get("email"),password:a.get("password"),role:a.get("role")};if(!n.displayName||!n.email||!n.password||!n.role){j(e,"Tous les champs sont obligatoires"),d.error("Veuillez remplir tous les champs");return}if(n.password.length<6){j(e,"Le mot de passe doit contenir au moins 6 caractères"),d.error("Mot de passe trop court (minimum 6 caractères)");return}s.disabled=!0,s.textContent="⏳ Création en cours...";const r=d.showLoadingToast("Création de l'utilisateur...");try{throw console.log("Création d'un nouvel utilisateur:",n.email),d.updateLoadingToast(r,"Cloud Function requise","error"),new Error(`⚠️ CLOUD FUNCTION REQUISE: Cette fonctionnalité nécessite une Cloud Function Firebase pour créer des utilisateurs avec mot de passe. Actuellement, seule l'authentification Google est supportée. Pour activer cette fonctionnalité:

1. Activer Email/Password dans Firebase Auth
2. Créer une Cloud Function createUser
3. Déployer la fonction sur Firebase`)}catch(i){console.error("❌ Erreur création utilisateur:",i),j(e,i.message)}finally{s.disabled=!1,s.textContent="➕ Créer l'utilisateur"}}function We(){const t="ABCDEFGHJKLMNPQRSTUVWXYZabcdefghjkmnpqrstuvwxyz23456789@#$%&";let o="";for(let a=0;a<12;a++)o+=t.charAt(Math.floor(Math.random()*t.length));const s=document.querySelector('input[name="password"]');s&&(s.value=o,s.type="text",navigator.clipboard.writeText(o).then(()=>{d.success("Mot de passe généré et copié ! Sauvegardez-le en lieu sûr.",5e3)}).catch(()=>{d.warning(`Mot de passe généré: ${o}

Copiez-le manuellement.`,7e3)}))}function j(t,e){t.textContent=e,t.classList.remove("hidden"),t.scrollIntoView({behavior:"smooth",block:"nearest"})}async function P(){try{if(document.getElementById("users-list")&&z("users-list",we(10)),g()){console.log("👥 Mode démo : Chargement des utilisateurs simulés..."),await new Promise(o=>setTimeout(o,500)),v=Fe.filter(o=>{if(f.role&&o.role!==f.role)return!1;if(f.status!=="all"){const s=new Date;s.setDate(s.getDate()-7);const n=o.lastLogin>s;if(f.status==="active"&&!n||f.status==="inactive"&&n)return!1}return!0}),console.log(`✅ ${v.length} utilisateurs simulés chargés`),I();return}const e={};if(f.role&&(e.role=f.role),v=await he(e),f.status!=="all"){const o=new Date;o.setDate(o.getDate()-7),v=v.filter(s=>{if(!s.lastLogin)return f.status==="inactive";const n=(s.lastLogin.toDate?s.lastLogin.toDate():new Date(s.lastLogin))>o;return f.status==="active"?n:!n})}console.log(`Utilisateurs charges: ${v.length}`),I()}catch(t){console.error("Erreur chargement utilisateurs:",t);const e=document.getElementById("users-list");e&&(e.innerHTML=`
                <div class="text-center py-12 text-red-500">
                    <svg class="w-16 h-16 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
    ...
    `}function Ke(t){const e=t.totalQuizzes||0,o=t.averageScore||0,s=t.currentStreak||0;return`
    ...
    `}function _e(){document.querySelectorAll(".edit-user-btn").forEach(t=>{t.addEventListener("click",e=>{const o=e.currentTarget.dataset.userId,s=e.currentTarget.dataset.userEmail,a=e.currentTarget.dataset.userRole;Ye(o,s,a)})})}function Ye(t,e,o){const s=document.createElement("div");s.id="edit-role-modal",s.className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4",s.innerHTML=`
    ...
    `,document.body.appendChild(s),document.getElementById("close-modal-btn")?.addEventListener("click",()=>s.remove()),document.getElementById("cancel-role-btn")?.addEventListener("click",()=>s.remove()),document.getElementById("save-role-btn")?.addEventListener("click",async()=>{const a=s.querySelector('input[name="role"]:checked')?.value;a&&(await Ze(t,e,a),s.remove())}),s.addEventListener("click",a=>{a.target===s&&s.remove()})}async function Ze(t,e,o){const s=document.getElementById("save-role-btn");if(!s)return;const a=s.innerHTML,n=d.showLoadingToast("Mise à jour du rôle...");try{s.disabled=!0,s.innerHTML='<svg class="animate-spin h-5 w-5 inline" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle></svg> Mise a jour...',await fe(t,o),d.updateLoadingToast(n,`Rôle mis à jour pour ${e}`,"success"),et(`Role mis a jour pour ${e}: ${o==="admin"?"Admin":"User"}`),await P(),await se()}catch(r){console.error("Erreur mise a jour role:",r),d.updateLoadingToast(n,"Erreur de mise à jour","error"),d.error(`Erreur: ${r.message||"Impossible de mettre a jour le role"}`,4e3),s.disabled=!1,s.innerHTML=a}}async function K(t){const e=t.target.id.replace("filter-user-","").replace("-","");f[e]=t.target.value,await P()}function Xe(t){const e=t.target.value.toLowerCase();if(!e){I();return}const o=v.filter(n=>n.displayName&&n.displayName.toLowerCase().includes(e)||n.email&&n.email.toLowerCase().includes(e)),s=document.getElementById("users-list");if(!s)return;if(o.length===0){s.innerHTML=`
            <div class="text-center py-12 text-slate-500">
                <p class="text-lg">Aucun resultat pour "${e}"</p>
            </div>
        `;return}const a=v;v=o,I(),v=a}async function se(){try{if(g()){console.log("📊 Mode démo : Chargement des stats utilisateurs simulées..."),_(Pe);return}const t=await ve();_(t)}catch(t){console.error("Erreur chargement stats:",t)}}function _(t){const e=document.getElementById("users-stats");if(!e)return;const o=t.total>0?Math.round(t.activeLastWeek/t.total*100):0;e.innerHTML=`
        <div class="bg-white rounded-xl shadow-md p-6">
    ...
    `}function et(t){const e=document.createElement("div");e.className="fixed top-4 right-4 bg-green-500 text-white px-6 py-4 rounded-lg shadow-xl z-50 animate-fade-in",e.innerHTML=`
        <div class="flex items-center gap-3">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
            </svg>
    ...
    `)}function Z(t){const e=document.getElementById("top-users-list");if(e){if(t.length===0){e.innerHTML=`
        ...
        `;return}e.innerHTML=t.map(o=>{const s=gt(o.completedAt),a=o.score>=80?"text-green-600":o.score>=60?"text-yellow-600":"text-red-600";return`
        ...
        `}).join("")}}function nt(){rt(),it(),lt()}async function rt(){const t=document.getElementById("chart-progress");if(t)try{let e,o,s;if(g()){console.log("📈 Mode démo : Création graphique progression simulé..."),e=[],o=[],s=[];for(let a=29;a>=0;a--){const n=new Date;n.setDate(n.getDate()-a),e.push(n.toLocaleDateString("fr-FR",{day:"2-digit",month:"short"})),o.push(Math.floor(Math.random()*15)+5),s.push(Math.floor(Math.random()*20)+70)}}else{const a=new Date;a.setDate(a.getDate()-30);const n=await E(S(y,"quizResults")),r={};for(let i=0;i<30;i++){const l=new Date;l.setDate(l.getDate()-i);const u=l.toISOString().split("T")[0];r[u]={count:0,totalScore:0}}n.forEach(i=>{const l=i.data(),u=l.completedAt?.toDate();if(u&&u>=a){const w=u.toISOString().split("T")[0];r[w]&&(r[w].count++,r[w].totalScore+=l.score||0)}}),e=Object.keys(r).reverse().map(i=>new Date(i).toLocaleDateString("fr-FR",{day:"2-digit",month:"short"})),o=Object.values(r).reverse().map(i=>i.count),s=Object.values(r).reverse().map(i=>i.count>0?Math.round(i.totalScore/i.count):0)}Q&&Q.destroy(),Q=new Chart(t,{type:"line",data:{labels:e,datasets:[{label:"Quiz complétés",data:o,borderColor:"rgb(99, 102, 241)",backgroundColor:"rgba(99, 102, 241, 0.1)",tension:.4,yAxisID:"y"},{label:"Score moyen (%)",data:s,borderColor:"rgb(34, 197, 94)",backgroundColor:"rgba(34, 197, 94, 0.1)",tension:.4,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},scales:{y:{type:"linear",display:!0,position:"left",title:{display:!0,text:"Nombre de quiz"}},y1:{type:"linear",display:!0,position:"right",title:{display:!0,text:"Score moyen (%)"},grid:{drawOnChartArea:!1}}},plugins:{legend:{position:"top"},title:{display:!0,text:"Évolution sur 30 jours"}}}})}catch(e){console.error("❌ Erreur création graphique progression:",e)}}async function it(){const t=document.getElementById("chart-modules");if(t)try{const e=await ne(),o=Object.keys(e),s=Object.values(e).map(n=>n.count),a=["rgba(99, 102, 241, 0.8)","rgba(34, 197, 94, 0.8)","rgba(251, 146, 60, 0.8)","rgba(236, 72, 153, 0.8)","rgba(14, 165, 233, 0.8)"];U&&U.destroy(),U=new Chart(t,{type:"doughnut",data:{labels:o,datasets:[{data:s,backgroundColor:a,borderWidth:2,borderColor:"#fff"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom"},title:{display:!0,text:"Répartition par module"}}}})}catch(e){console.error("❌ Erreur création graphique modules:",e)}}async function lt(){const t=document.getElementById("chart-activity");if(t)try{const e=[],o=[];for(let s=6;s>=0;s--){const a=new Date;a.setDate(a.getDate()-s),e.push(a.toLocaleDateString("fr-FR",{weekday:"short"})),o.push(Math.floor(Math.random()*20)+5)}H&&H.destroy(),H=new Chart(t,{type:"bar",data:{labels:e,datasets:[{label:"Utilisateurs actifs",data:o,backgroundColor:"rgba(99, 102, 241, 0.8)",borderColor:"rgb(99, 102, 241)",borderWidth:1}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},title:{display:!0,text:"Activité des 7 derniers jours"}},scales:{y:{beginAtZero:!0,ticks:{stepSize:5}}}}})}catch(e){console.error("❌ Erreur création graphique activité:",e)}}async function ct(){const t=d.showLoadingToast("Génération du PDF...");try{const{jsPDF:e}=window.jspdf,o=new e;o.setFontSize(20),o.text("Dashboard Admin - QuizPro",20,20),o.setFontSize(10),o.text(`Généré le ${new Date().toLocaleDateString("fr-FR")}`,20,30),o.setFontSize(14),o.text("Statistiques Globales",20,45),o.setFontSize(10);let s=55;o.text(`Total Utilisateurs: ${c.totalUsers}`,25,s),s+=7,o.text(`Total Quiz: ${c.totalQuizzes}`,25,s),s+=7,o.text(`Score Moyen: ${c.avgScore}%`,25,s),s+=7,o.text(`Questions: ${c.totalQuestions}`,25,s),s+=7,o.text(`Ressources: ${c.totalResources}`,25,s),o.save(`dashboard-admin-${new Date().toISOString().split("T")[0]}.pdf`),d.updateLoadingToast(t,"PDF généré avec succès !","success")}catch(e){console.error("❌ Erreur export PDF:",e),d.updateLoadingToast(t,"Erreur d'export PDF","error"),d.error("Erreur: Assurez-vous que jsPDF est chargé",4e3)}}async function dt(){const t=d.showLoadingToast("Génération du CSV...");try{const e=await E(S(y,"quizResults")),o=["Date","Utilisateur","Module","Mois","Année","Score (%)","Bonnes réponses","Total questions","Temps (s)"],s=[];e.forEach(i=>{const l=i.data(),u=l.completedAt?.toDate().toLocaleString("fr-FR")||"N/A";s.push([u,l.userName||"Inconnu",l.module||"N/A",l.month||"N/A",l.year||"N/A",l.score||0,l.correctAnswers||0,l.totalQuestions||0,l.timeSpent||0])});const a=[o,...s].map(i=>i.join(",")).join(`
`),n=new Blob([a],{type:"text/csv;charset=utf-8;"}),r=document.createElement("a");r.href=URL.createObjectURL(n),r.download=`dashboard-complet-${new Date().toISOString().split("T")[0]}.csv`,r.click(),d.updateLoadingToast(t,"CSV généré avec succès !","success")}catch(e){console.error("❌ Erreur export CSV:",e),d.updateLoadingToast(t,"Erreur d'export CSV","error"),d.error("Erreur lors de l'export CSV",4e3)}}function ut(){document.getElementById("export-pdf-btn")?.addEventListener("click",ct),document.getElementById("export-csv-btn")?.addEventListener("click",dt),document.getElementById("period-filter")?.addEventListener("change",mt),document.getElementById("refresh-dashboard-btn")?.addEventListener("click",()=>{d.info("Actualisation du dashboard...",2e3),ae()})}async function mt(t){const e=t.target.value;d.info(`Filtrage: ${e}`,2e3)}function pt(){document.getElementById("global-stats-cards")&&z("global-stats-cards",ye(4)),document.getElementById("top-users-list")&&z("top-users-list",J(10)),document.getElementById("recent-activity-list")&&z("recent-activity-list",J(8));const s=document.getElementById("progress-chart");s&&(s.innerHTML=q());const a=document.getElementById("modules-chart");a&&(a.innerHTML=q());const n=document.getElementById("activity-chart");n&&(n.innerHTML=q())}function gt(t){const o=new Date-t,s=Math.floor(o/1e3),a=Math.floor(s/60),n=Math.floor(a/60),r=Math.floor(n/24);return r>0?`Il y a ${r}j`:n>0?`Il y a ${n}h`:a>0?`Il y a ${a}min`:"À l'instant"}Me().then(t=>{console.log("Admin authentifié:",t.email),d.success(`Bienvenue ${t.displayName||t.email} !`,3e3);const e=document.getElementById("admin-name"),o=document.getElementById("admin-avatar");e&&(e.textContent=t.displayName||t.email),o&&t.photoURL&&(o.src=t.photoURL),ae(),ke(),Oe(),ht()}).catch(t=>{console.error("Erreur authentification admin:",t)});function ht(){const t=document.getElementById("tab-dashboard-btn"),e=document.getElementById("tab-questions-btn"),o=document.getElementById("tab-users-btn"),s=document.getElementById("tab-dashboard"),a=document.getElementById("tab-questions"),n=document.getElementById("tab-users");function r(i,l){[t,e,o].forEach(u=>{u.classList.remove("border-indigo-600","text-indigo-600"),u.classList.add("border-transparent","text-slate-600"),u.setAttribute("aria-selected","false")}),[s,a,n].forEach(u=>{u.classList.add("tab-hidden")}),i.classList.remove("border-transparent","text-slate-600"),i.classList.add("border-indigo-600","text-indigo-600"),i.setAttribute("aria-selected","true"),l.classList.remove("tab-hidden")}t.addEventListener("click",()=>r(t,s)),e.addEventListener("click",()=>r(e,a)),o.addEventListener("click",()=>r(o,n))}document.getElementById("signout-link")?.addEventListener("click",t=>{t.preventDefault(),confirm("Voulez-vous vraiment vous déconnecter ?")&&be().then(()=>{window.location.href="/"})});
//# sourceMappingURL=admin-Cs5VGgUh.js.map
