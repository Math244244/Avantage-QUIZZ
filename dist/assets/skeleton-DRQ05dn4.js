function d(t=5){const s=[];for(let e=0;e<t;e++)s.push(`
        ...
        `);return s.join("")}function l(){return`
    ...
    `}function i(t=5){const s=[];for(let e=0;e<t;e++)s.push(`
        ...
        `);return s.join("")}function a(t=10){const s=[];for(let e=0;e<t;e++)s.push(`
        ...
        `);return s.join("")}function n(t=5){const s=[];for(let e=0;e<t;e++)s.push(`
        ...
        `);return s.join("")}function o(t=6){const s=[];for(let e=0;e<t;e++)s.push(`
        ...
        `);return s.join("")}function v(t=4){const s=[];for(let e=0;e<t;e++)s.push(`
        ...
        `);return s.join("")}function r(t,s){const e=document.getElementById(t);e&&(e.innerHTML=s)}export{a,v as b,i as c,l as d,d as e,n as f,o as g,r as s};
//# sourceMappingURL=skeleton-DRQ05dn4.js.map
