const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/services-Xx4j0R6D.js","assets/quiz-CJ_Na2QZ.js"])))=>i.map(i=>d[i]);
import{c as Le,g as Me,a as $e,b as ze,d as De,e as Ie,i as Te,f as ge,h as Be,u as qe,s as x,j as W}from"./services-Xx4j0R6D.js";import{getFirestore as je,query as j,collection as N,where as q,limit as ee,getDocs as U,Timestamp as Ne,orderBy as ve}from"https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js";import{initializeApp as Ue}from"https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js";import{getAuth as Qe,GoogleAuthProvider as Fe,signInWithPopup as Pe,signOut as He,onAuthStateChanged as Re}from"https://www.gstatic.com/firebasejs/10.7.1/firebase-auth.js";import{getDatabase as Oe}from"https://www.gstatic.com/firebasejs/10.7.1/firebase-database.js";import{getFunctions as Ve,httpsCallable as he}from"https://www.gstatic.com/firebasejs/10.7.1/firebase-functions.js";function _e(e){if(!e||typeof e!="string")return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}function v(e){return _e(e)}function R(e,t="info",s=3e3){const o=fe(),n=We(e,t);return o.appendChild(n),setTimeout(()=>n.classList.add("show"),10),s>0&&setTimeout(()=>{O(n)},s),n}function fe(){let e=document.getElementById("toast-container");return e||(e=document.createElement("div"),e.id="toast-container",e.className="fixed top-4 right-4 z-50 flex flex-col gap-3",document.body.appendChild(e)),e}function We(e,t){const s=document.createElement("div");s.className=`toast toast-${t} transform translate-x-full transition-all duration-300`,t==="error"?(s.setAttribute("role","alert"),s.setAttribute("aria-live","assertive")):(s.setAttribute("role","status"),s.setAttribute("aria-live","polite")),s.setAttribute("aria-atomic","true");const o=be(t);return s.innerHTML=`
    ...
    `,s.querySelector(".toast-close").addEventListener("click",()=>O(s)),s}function be(e){const t={success:{borderColor:"border-green-500",icon:`<div class="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
            ...
            </div>`}};return t[e]||t.info}function O(e){e.classList.remove("show"),e.classList.add("translate-x-full"),setTimeout(()=>{e.remove();const t=document.getElementById("toast-container");t&&t.children.length===0&&t.remove()},300)}const p={success:(e,t)=>R(e,"success",t),error:(e,t)=>R(e,"error",t),warning:(e,t)=>R(e,"warning",t),info:(e,t)=>R(e,"info",t)};function Jt(e){const t=fe(),s=document.createElement("div");return s.className="toast toast-loading transform translate-x-full transition-all duration-300",s.setAttribute("data-loading","true"),s.innerHTML=`
    ...
    `,t.appendChild(s),setTimeout(()=>s.classList.add("show"),10),s}function Gt(e,t,s="success"){if(!e||!e.getAttribute("data-loading"))return;const o=be(s),n=e.classList.contains("show");e.className=`toast toast-${s} transform transition-all duration-300${n?" show":""}`,e.innerHTML=`
        <div class="flex items-center gap-3 bg-white rounded-lg shadow-lg border-l-4 ${o.borderColor} p-4 min-w-[320px] max-w-md">
            <div class="flex-shrink-0">
                ${o.icon}
            </div>
    ...
    `,document.head.appendChild(e)}const D=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.location.hostname==="192.168.1.1"||window.location.port==="3200",c={log:(...e)=>{D&&console.log(...e)},error:(...e)=>{console.error(...e)},warn:(...e)=>{D&&console.warn(...e)},info:(...e)=>{D&&console.info(...e)},group:(...e)=>{D&&console.group(...e)},groupEnd:()=>{D&&console.groupEnd()},table:(...e)=>{D&&console.table(...e)}};console.log(D?"🔧 Mode développement - Logs activés":"🚀 Mode production - Logs désactivés (sauf erreurs)");const we={apiKey:"AIzaSyD8w7Em_xdMGplscfGLrnM72vmm4z5ZTr0",authDomain:"avantage-quizz.firebaseapp.com",databaseURL:"https://avantage-quizz-default-rtdb.firebaseio.com",projectId:"avantage-quizz",storageBucket:"avantage-quizz.firebasestorage.app",messagingSenderId:"919472910099",appId:"1:919472910099:web:e17d4c1cdc7a04c6cab4e6"},H=Ue(we),I=Qe(H),T=je(H);Oe(H);const se=Ve(H);c.log("✅ Firebase initialisé avec succès");c.log("📊 Projet:",we.projectId);c.log("🔐 Services: Authentication, Firestore, Realtime Database");const Kt=Object.freeze(Object.defineProperty({__proto__:null,app:H,auth:I,db:T,functions:se},Symbol.toStringTag,{value:"Module"})),Je="modulepreload",Ge=function(e){return"/"+e},re={},te=function(t,s,o){let n=Promise.resolve();if(s&&s.length>0){let g=function(u){return Promise.all(u.map(d=>Promise.resolve(d).then(l=>({status:"fulfilled",value:l}),l=>({status:"rejected",reason:l}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),i=r?.nonce||r?.getAttribute("nonce");n=g(s.map(u=>{if(u=Ge(u),u in re)return;re[u]=!0;const d=u.endsWith(".css"),l=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${l}`))return;const m=document.createElement("link");if(m.rel=d?"stylesheet":Je,d||(m.as="script"),m.crossOrigin="",m.href=u,i&&m.setAttribute("nonce",i),document.head.appendChild(m),d)return new Promise((E,L)=>{m.addEventListener("load",E),m.addEventListener("error",()=>L(new Error(`Unable to preload CSS for ${u}`)))})}))}function a(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return n.then(r=>{for(const i of r||[])i.status==="rejected"&&a(i.reason);return t().catch(a)})},xe=new Fe;xe.setCustomParameters({prompt:"select_account"});let G=!1;async function Yt(){if(G)return console.warn("⚠️ Connexion déjà en cours, veuillez patienter..."),null;G=!0;try{console.log("🔐 Tentative de connexion Google...");const t=(await Pe(I,xe)).user;return console.log("✅ Authentification réussie:",t.displayName),console.log("📧 Email:",t.email),await Le(t),t}catch(e){console.error("❌ Erreur de connexion:",e);let t="Erreur lors de la connexion. Veuillez réessayer.";if(e.code==="auth/popup-closed-by-user")t="Connexion annulée. Veuillez réessayer.";else if(e.code==="auth/popup-blocked")t="Pop-up bloquée. Autorisez les pop-ups pour ce site.";else if(e.code==="auth/unauthorized-domain")t="Domaine non autorisé. Configurez Firebase Authentication.";else if(e.code==="auth/cancelled-popup-request")return console.warn("⚠️ Requête de popup annulée (clic multiple)"),null;throw e.code!=="auth/cancelled-popup-request"&&alert(t),e}finally{setTimeout(()=>{G=!1},2e3)}}async function Zt(){try{const e=I.currentUser?.displayName||"Utilisateur";await He(I),console.log("✅ Déconnexion réussie:",e)}catch(e){throw console.error("❌ Erreur de déconnexion:",e),e}}function Xt(e){return Re(I,t=>{t?console.log("👤 Utilisateur connecté:",t.email):console.log("👤 Aucun utilisateur connecté"),e(t)})}function Ke(){return I.currentUser}async function es(e){if(!e)return;if(e.role==="admin"){const s=document.getElementById("nav-admin-item");s&&s.classList.remove("hidden");const o=document.getElementById("admin-badge-nav");o&&o.classList.remove("hidden"),console.log("Admin UI elements shown")}}function w(){return localStorage.getItem("authMode")==="demo"}function ye(){try{const e=localStorage.getItem("demoUser");return e?JSON.parse(e):null}catch(e){return console.error("❌ Erreur lecture utilisateur démo:",e),null}}function ts(){return w()?ye():Ke()}async function ss(){return new Promise((e,t)=>{if(w()){const o=ye();if(o&&o.role==="admin"){console.log("✅ Admin autorisé (mode démo):",o.email),e(o);return}else{console.warn("❌ Accès refusé: utilisateur démo non admin"),alert("Accès refusé. Cette page est réservée aux administrateurs."),window.location.href="/index.html",t(new Error("Non autorisé"));return}}const s=I.onAuthStateChanged(async o=>{if(s(),!o){console.warn("❌ Accès refusé: Utilisateur non connecté"),window.location.href="/index.html",t(new Error("Non authentifié"));return}try{const n=await Me(o.uid);if(!n||n.role!=="admin"){console.warn("❌ Accès refusé: Utilisateur non administrateur"),alert("Accès refusé. Cette page est réservée aux administrateurs."),window.location.href="/index.html",t(new Error("Non autorisé"));return}console.log("✅ Admin autorisé:",o.email),e(o)}catch(n){console.error("❌ Erreur vérification admin:",n),window.location.href="/index.html",t(n)}})})}function ie(e=5){const t=[];for(let s=0;s<e;s++)t.push(`
    ...
    `}function Ye(e=5){const t=[];for(let s=0;s<e;s++)t.push(`
        ...
        `);return t.join("")}function Ze(e=10){const t=[];for(let s=0;s<e;s++)t.push(`
        ...
        `);return t.join("")}function os(e=5){const t=[];for(let s=0;s<e;s++)t.push(`
        ...
        `);return t.join("")}function ns(e=6){const t=[];for(let s=0;s<e;s++)t.push(`
        ...
        `);return t.join("")}function Xe(e=4){const t=[];for(let s=0;s<e;s++)t.push(`
        ...
        `);return t.join("")}function F(e,t){const s=document.getElementById(e);s&&(s.innerHTML=t)}const ke="avantage-quizz-demo-questions";function et(){if(!w())return[];const e=localStorage.getItem(ke);if(e)try{return JSON.parse(e).map(s=>({...s,createdAt:new Date(s.createdAt)}))}catch(t){console.warn("⚠️ Erreur lecture questions démo:",t)}return[{id:"1",module:"auto",month:11,year:2025,question:"Quelle est la pression recommandée pour les pneus d'une voiture standard ?",options:["32 PSI","25 PSI","40 PSI","50 PSI"],correctAnswer:0,explanation:"La pression recommandée est généralement de 32 PSI pour un véhicule standard.",createdAt:new Date},{id:"2",module:"auto",month:11,year:2025,question:"À quelle fréquence doit-on changer l'huile moteur ?",options:["Tous les 5000 km","Tous les 10000 km","Tous les 15000 km","Tous les 20000 km"],correctAnswer:1,explanation:"Il est recommandé de changer l'huile tous les 10000 km ou selon les recommandations du fabricant.",createdAt:new Date},{id:"3",module:"loisir",month:11,year:2025,question:"Quel est le poids maximal recommandé pour un bateau remorqué ?",options:["1500 kg","2000 kg","2500 kg","3000 kg"],correctAnswer:2,explanation:"Pour un véhicule standard, 2500 kg est souvent la limite recommandée.",createdAt:new Date},{id:"4",module:"vr",month:10,year:2025,question:"Quelle est la capacité minimale recommandée pour une batterie de VR ?",options:["75 Ah","100 Ah","125 Ah","150 Ah"],correctAnswer:1,explanation:"Une batterie de 100 Ah est le minimum recommandé pour un VR.",createdAt:new Date},{id:"5",module:"tracteur",month:10,year:2025,question:"À quelle profondeur doit-on labourer pour les cultures céréalières ?",options:["10-15 cm","20-25 cm","30-35 cm","40-45 cm"],correctAnswer:1,explanation:"La profondeur idéale est de 20-25 cm pour les céréales.",createdAt:new Date}]}function oe(e){w()&&(localStorage.setItem(ke,JSON.stringify(e)),console.log("💾 Questions démo sauvegardées:",e.length))}let $=et();const tt={total:240,byModule:{auto:85,loisir:62,vr:54,tracteur:39},recent:12};let S=[],y={module:"",month:"",year:new Date().getFullYear()},C=1;const V=20;async function as(){console.log("Initialisation du gestionnaire de questions"),await z(),await B(),st()}function st(){const e=document.getElementById("create-question-form");e&&e.addEventListener("submit",nt);const t=document.getElementById("json-file-input");t&&t.addEventListener("change",at);const s=document.getElementById("browse-json-btn");s&&s.addEventListener("click",()=>t?.click());const o=document.getElementById("filter-module"),n=document.getElementById("filter-month"),a=document.getElementById("filter-year"),r=document.getElementById("search-questions"),i=document.getElementById("questions-list");o&&o.addEventListener("change",Y),n&&n.addEventListener("change",Y),a&&a.addEventListener("change",Y),r&&r.addEventListener("input",ut),i&&!i.dataset.eventsBound&&(i.addEventListener("click",ot),i.dataset.eventsBound="true");const g=document.getElementById("prev-page-btn"),u=document.getElementById("next-page-btn");g&&g.addEventListener("click",()=>le(-1)),u&&u.addEventListener("click",()=>le(1))}function ot(e){const t=e.target.closest(".edit-question-btn, .delete-question-btn");if(!t)return;const s=t.dataset.questionId;if(s){if(t.classList.contains("edit-question-btn")){ct(s);return}t.classList.contains("delete-question-btn")&&dt(s)}}async function z(){try{if(document.getElementById("questions-list")&&F("questions-list",Ye(5)),w()){console.log("📝 Mode démo : Chargement des questions simulées..."),await new Promise(s=>setTimeout(s,500)),S=$.filter(s=>!(y.module&&s.module!==y.module||y.month&&s.month!==parseInt(y.month)||y.year&&s.year!==parseInt(y.year))),console.log(`✅ ${S.length} questions simulées chargées`),_();return}const t={};y.module&&(t.module=y.module),y.month&&(t.month=parseInt(y.month)),y.year&&(t.year=parseInt(y.year)),S=await $e(t),console.log(`Questions chargees: ${S.length}`),_()}catch(e){console.error("Erreur chargement questions:",e);const t=document.getElementById("questions-list");t&&(t.innerHTML=`
            ...
            `)}}function _(){const e=document.getElementById("questions-list");if(!e)return;if(S.length===0){const a=document.createElement("div");a.className="text-center py-12 text-slate-500",a.innerHTML=`
        ...
        `,e.replaceChildren(a);return}const t=(C-1)*V,s=t+V,o=S.slice(t,s),n=document.createDocumentFragment();o.forEach(a=>{n.appendChild(Se(a))}),e.replaceChildren(n),mt()}function Se(e){const t={auto:"indigo",loisir:"cyan",vr:"orange",tracteur:"green"},s={auto:"🚗",loisir:"🏔️",vr:"🚐",tracteur:"🚜"},o=t[e.module]||"gray",n=s[e.module]||"📝",r=["Jan","Fev","Mar","Avr","Mai","Juin","Juil","Aout","Sep","Oct","Nov","Dec"][e.month-1]||e.month,i=e.createdAt?.seconds?new Date(e.createdAt.seconds*1e3):e.createdAt instanceof Date?e.createdAt:null,g=i?i.toLocaleDateString("fr-FR"):"N/A",u=document.createElement("template");return u.innerHTML=`
            ...
            <div class="flex items-start justify-between mb-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="ml-2 text-sm text-slate-500">${A(`${r} ${e.year}`)}</span>
                    </div>
                </div>
                <div class="flex gap-2">
            ...
            <div class="bg-white rounded-lg p-4 mb-4 max-h-60 overflow-y-auto">
                ...
                <ol class="space-y-2 text-sm text-slate-700">
                    ${e.questions.slice(0,5).map((a,r)=>`
                        <li><strong>${r+1}.</strong> ${A(a.question.substring(0,80))}${a.question.length>80?"...":""}</li>
                    `).join("")}
    ...
    `,document.getElementById("confirm-import-btn")?.addEventListener("click",()=>lt(e)),document.getElementById("cancel-import-btn")?.addEventListener("click",()=>{s.innerHTML="",document.getElementById("json-file-input").value=""})}async function lt(e){const t=document.getElementById("json-preview"),s=document.getElementById("confirm-import-btn");try{if(s.disabled=!0,s.innerHTML='<svg class="animate-spin h-5 w-5 inline" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle></svg> Import en cours...',w()){console.log("📝 Mode démo : Simulation import JSON..."),await new Promise(a=>setTimeout(a,1e3));const n=e.questions||[];n.forEach((a,r)=>{$.unshift({id:`demo-imported-${Date.now()}-${r}`,question:a.question,options:a.options,correctAnswer:a.correctAnswer,explanation:a.explanation||"Pas d'explication fournie",module:e.module,month:e.month,year:e.year,createdAt:new Date})}),oe($),Q(`✅ Import terminé (mode démo): ${n.length} questions importées`),t.innerHTML="",document.getElementById("json-file-input").value="",await z(),await B();return}const o=await Te(e);Q(`Import termine: ${o.success}/${o.total} questions importees`),o.errors.length>0&&console.warn("Erreurs import:",o.errors),t.innerHTML="",document.getElementById("json-file-input").value="",await z(),await B()}catch(o){console.error("Erreur import:",o),J("json-preview",o.message||"Erreur lors de l import")}}function ct(e){S.find(s=>s.id===e)&&alert(`Edition de la question ${e}
A implementer: modal d'edition`)}async function dt(e){const t=S.find(o=>o.id===e);if(!(!t||!confirm(`Voulez-vous vraiment supprimer cette question?

"${t.question.substring(0,100)}..."

Cette action est irreversible.`)))try{if(w()){console.log("📝 Mode démo : Simulation suppression question..."),await new Promise(n=>setTimeout(n,300));const o=$.findIndex(n=>n.id===e);o>-1&&($.splice(o,1),oe($)),Q("✅ Question supprimée avec succès (mode démo)"),await z(),await B();return}await Ie(e),Q("Question supprimee avec succes"),await z(),await B()}catch(o){console.error("Erreur suppression:",o),J("questions-list",o.message||"Erreur lors de la suppression")}}async function Y(e){const t=e.target.id.replace("filter-","");y[t]=e.target.value,C=1,await z()}function ut(e){const t=e.target.value.toLowerCase();if(!t){_();return}const s=S.filter(a=>a.question.toLowerCase().includes(t)||a.options.some(r=>r.toLowerCase().includes(t))||a.explanation.toLowerCase().includes(t)),o=document.getElementById("questions-list");if(!o)return;if(s.length===0){const a=document.createElement("div");a.className="text-center py-12 text-slate-500",a.innerHTML=`
            <p class="text-lg">Aucun resultat pour "${A(t)}"</p>
        `,o.replaceChildren(a);return}const n=document.createDocumentFragment();s.forEach(a=>{n.appendChild(Se(a))}),o.replaceChildren(n)}function le(e){const t=Math.ceil(S.length/V);C+=e,C<1&&(C=1),C>t&&(C=t),_(),window.scrollTo({top:0,behavior:"smooth"})}function mt(){const e=Math.ceil(S.length/V),t=document.getElementById("page-info"),s=document.getElementById("prev-page-btn"),o=document.getElementById("next-page-btn");t&&(t.textContent=`Page ${C}/${e||1}`),s&&(s.disabled=C===1),o&&(o.disabled=C===e||e===0)}async function B(){try{if(w()){console.log("📊 Mode démo : Chargement des stats simulées..."),ce(tt);return}const e=await ze();ce(e)}catch(e){console.error("Erreur chargement stats:",e)}}function ce(e){const t=document.getElementById("questions-stats");if(!t)return;const s={auto:"Auto",loisir:"Loisir",vr:"VR",tracteur:"Tracteur"};t.innerHTML=`
                ...
                ${Object.entries(e.byModule).map(([o,n])=>{const a=(n/e.total*100).toFixed(0);return`
                        <div>
                            ...
                            <div class="bg-slate-200 rounded-full h-2">
                                <div class="bg-indigo-600 rounded-full h-2 transition-all" style="width: ${a}%"></div>
                            </div>
                        </div>
                    `}).join("")}
            </div>
        </div>
    `}function pt(e){const t=document.getElementById(e);t&&(t.innerHTML=`
    ...
    `,document.body.appendChild(t),setTimeout(()=>{t.remove()},3e3)}function A(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}const gt=[{id:"1",email:"admin@avantage-quizz.com",displayName:"Administrateur Principal",role:"admin",totalQuizzes:0,averageScore:0,createdAt:new Date("2025-01-15"),lastLogin:new Date},{id:"2",email:"alice.dupont@example.com",displayName:"Alice Dupont",role:"user",totalQuizzes:24,averageScore:92,createdAt:new Date("2025-02-20"),lastLogin:new Date},{id:"3",email:"bob.martin@example.com",displayName:"Bob Martin",role:"user",totalQuizzes:21,averageScore:88,createdAt:new Date("2025-03-10"),lastLogin:new Date(Date.now()-864e5)},{id:"4",email:"claire.bernard@example.com",displayName:"Claire Bernard",role:"user",totalQuizzes:19,averageScore:85,createdAt:new Date("2025-03-25"),lastLogin:new Date(Date.now()-1728e5)},{id:"5",email:"david.dubois@example.com",displayName:"David Dubois",role:"user",totalQuizzes:18,averageScore:83,createdAt:new Date("2025-04-05"),lastLogin:new Date(Date.now()-2592e5)}],vt={total:42,admins:2,regularUsers:40,activeToday:8,activeWeek:23};let f=[],b={role:"",status:"all"},h={lastDoc:null,hasMore:!1,isLoading:!1,pageSize:20};async function rs(){console.log("Initialisation du gestionnaire utilisateurs"),await ne(),await Ce(),ht()}function ht(){const e=document.getElementById("create-user-form");e&&e.addEventListener("submit",ft);const t=document.getElementById("generate-password-btn");t&&t.addEventListener("click",bt);const s=document.getElementById("filter-user-role"),o=document.getElementById("filter-user-status"),n=document.getElementById("search-users");s&&s.addEventListener("change",de),o&&o.addEventListener("change",de),n&&n.addEventListener("input",Ct)}async function ft(e){e.preventDefault();const t=document.getElementById("create-user-error"),s=document.getElementById("create-user-success"),o=document.getElementById("create-user-btn");t.classList.add("hidden"),s.classList.add("hidden");const n=new FormData(e.target),a={displayName:n.get("displayName"),email:n.get("email"),password:n.get("password"),role:n.get("role")};if(!a.displayName||!a.email||!a.password||!a.role){Z(t,"Tous les champs sont obligatoires"),p.error("Veuillez remplir tous les champs");return}if(a.password.length<6){Z(t,"Le mot de passe doit contenir au moins 6 caractères"),p.error("Mot de passe trop court (minimum 6 caractères)");return}o.disabled=!0,o.textContent="⏳ Création en cours...";const r=p.showLoadingToast("Création de l'utilisateur...");try{throw console.log("Création d'un nouvel utilisateur:",a.email),p.updateLoadingToast(r,"Cloud Function requise","error"),new Error(`⚠️ CLOUD FUNCTION REQUISE: Cette fonctionnalité nécessite une Cloud Function Firebase pour créer des utilisateurs avec mot de passe. Actuellement, seule l'authentification Google est supportée. Pour activer cette fonctionnalité:

1. Activer Email/Password dans Firebase Auth
2. Créer une Cloud Function createUser
3. Déployer la fonction sur Firebase`)}catch(i){console.error("❌ Erreur création utilisateur:",i),Z(t,i.message)}finally{o.disabled=!1,o.textContent="➕ Créer l'utilisateur"}}function bt(){const e="ABCDEFGHJKLMNPQRSTUVWXYZabcdefghjkmnpqrstuvwxyz23456789@#$%&";let s="";for(let n=0;n<12;n++)s+=e.charAt(Math.floor(Math.random()*e.length));const o=document.querySelector('input[name="password"]');o&&(o.value=s,o.type="text",navigator.clipboard.writeText(s).then(()=>{p.success("Mot de passe généré et copié ! Sauvegardez-le en lieu sûr.",5e3)}).catch(()=>{p.warning(`Mot de passe généré: ${s}

Copiez-le manuellement.`,7e3)}))}function Z(e,t){e.textContent=t,e.classList.remove("hidden"),e.scrollIntoView({behavior:"smooth",block:"nearest"})}async function ne(){try{if(document.getElementById("users-list")&&F("users-list",Ze(10)),w()){console.log("👥 Mode démo : Chargement des utilisateurs simulés..."),await new Promise(o=>setTimeout(o,500)),f=gt.filter(o=>{if(b.role&&o.role!==b.role)return!1;if(b.status!=="all"){const n=new Date;n.setDate(n.getDate()-7);const r=o.lastLogin>n;if(b.status==="active"&&!r||b.status==="inactive"&&r)return!1}return!0}),console.log(`✅ ${f.length} utilisateurs simulés chargés`),P();return}const t={};b.role&&(t.role=b.role),h.lastDoc=null,h.hasMore=!1;const s=await ge(t,h.pageSize,null);if(f=s.users,h.lastDoc=s.lastDoc,h.hasMore=s.hasMore,b.status!=="all"){const o=new Date;o.setDate(o.getDate()-7),f=f.filter(n=>{if(!n.lastLogin)return b.status==="inactive";const r=(n.lastLogin.toDate?n.lastLogin.toDate():new Date(n.lastLogin))>o;return b.status==="active"?r:!r})}console.log(`Utilisateurs charges: ${f.length}`),P(),Ee()}catch(e){console.error("Erreur chargement utilisateurs:",e);const t=document.getElementById("users-list");if(t){const s=v(e.message);t.innerHTML=`
                <div class="text-center py-12 text-red-500">
                    <svg class="w-16 h-16 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
        ...
        `;return}e.innerHTML=f.map(t=>xt(t)).join(""),kt()}}async function wt(){if(!(h.isLoading||!h.hasMore))try{h.isLoading=!0;const e={};b.role&&(e.role=b.role);const t=await ge(e,h.pageSize,h.lastDoc);let s=t.users;if(b.status!=="all"){const o=new Date;o.setDate(o.getDate()-7),s=s.filter(n=>{if(!n.lastLogin)return b.status==="inactive";const r=(n.lastLogin.toDate?n.lastLogin.toDate():new Date(n.lastLogin))>o;return b.status==="active"?r:!r})}f=[...f,...s],h.lastDoc=t.lastDoc,h.hasMore=t.hasMore,P(),Ee(),console.log(`✅ ${s.length} utilisateurs supplémentaires chargés`)}catch(e){console.error("❌ Erreur chargement utilisateurs supplémentaires:",e),p.error("Erreur lors du chargement des utilisateurs supplémentaires")}finally{h.isLoading=!1}}function Ee(){const e=document.getElementById("users-pagination-controls");if(e&&e.remove(),!h.hasMore&&f.length<=h.pageSize)return;const t=document.getElementById("users-list");if(!t)return;const s=`
    ...
    `;t.insertAdjacentHTML("beforeend",s);const o=document.getElementById("load-more-users-btn");o&&o.addEventListener("click",wt)}function xt(e){const t=e.role==="admin",s=t?"yellow":"blue",o=t?"🔰":"👤",n=e.lastLogin?e.lastLogin.toDate?e.lastLogin.toDate():new Date(e.lastLogin):null,a=e.createdAt?e.createdAt.toDate?e.createdAt.toDate():new Date(e.createdAt):null,r=n&&new Date-n<10080*60*1e3,i=n?Lt(n):"Jamais connecte",g=v(e.displayName||"Sans nom"),u=v(e.email||""),d=v(e.displayName||"User"),l=e.photoURL||`https://ui-avatars.com/api/?name=${encodeURIComponent(e.displayName||e.email)}&background=667eea&color=fff&size=128`;return`
    ...
    `}function yt(e){const t=e.totalQuizzes||0,s=e.averageScore||0,o=e.currentStreak||0;return`
    ...
    `}function kt(){document.querySelectorAll(".edit-user-btn").forEach(e=>{e.addEventListener("click",t=>{const s=t.currentTarget.dataset.userId,o=t.currentTarget.dataset.userEmail,n=t.currentTarget.dataset.userRole;St(s,o,n)})})}function St(e,t,s){const o=document.createElement("div");o.id="edit-role-modal",o.className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4",o.innerHTML=`
    ...
    `,document.body.appendChild(o),document.getElementById("close-modal-btn")?.addEventListener("click",()=>o.remove()),document.getElementById("cancel-role-btn")?.addEventListener("click",()=>o.remove()),document.getElementById("save-role-btn")?.addEventListener("click",async()=>{const n=o.querySelector('input[name="role"]:checked')?.value;n&&(await Et(e,t,n),o.remove())}),o.addEventListener("click",n=>{n.target===o&&o.remove()})}async function Et(e,t,s){const o=document.getElementById("save-role-btn");if(!o)return;const n=o.innerHTML,a=p.showLoadingToast("Mise à jour du rôle...");try{o.disabled=!0,o.innerHTML='<svg class="animate-spin h-5 w-5 inline" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle></svg> Mise a jour...',await qe(e,s),p.updateLoadingToast(a,`Rôle mis à jour pour ${t}`,"success"),At(`Role mis a jour pour ${t}: ${s==="admin"?"Admin":"User"}`),await ne(),await Ce()}catch(r){console.error("Erreur mise a jour role:",r),p.updateLoadingToast(a,"Erreur de mise à jour","error"),p.error(`Erreur: ${r.message||"Impossible de mettre a jour le role"}`,4e3),o.disabled=!1,o.innerHTML=n}}async function de(e){const t=e.target.id.replace("filter-user-","").replace("-","");b[t]=e.target.value,await ne()}function Ct(e){const t=e.target.value.toLowerCase();if(!t){P();return}const s=f.filter(a=>a.displayName&&a.displayName.toLowerCase().includes(t)||a.email&&a.email.toLowerCase().includes(t)),o=document.getElementById("users-list");if(!o)return;if(s.length===0){const a=v(t);o.innerHTML=`
            <div class="text-center py-12 text-slate-500">
                <p class="text-lg">Aucun resultat pour "${a}"</p>
            </div>
        `;return}const n=f;f=s,P(),f=n}async function Ce(){try{if(w()){console.log("📊 Mode démo : Chargement des stats utilisateurs simulées..."),ue(vt);return}const e=await Be();ue(e)}catch(e){console.error("Erreur chargement stats:",e)}}function ue(e){const t=document.getElementById("users-stats");if(!t)return;const s=e.total>0?Math.round(e.activeLastWeek/e.total*100):0;t.innerHTML=`
        <div class="bg-white rounded-xl shadow-md p-6">
    ...
    `}function At(e){const t=document.createElement("div");t.className="fixed top-4 right-4 bg-green-500 text-white px-6 py-4 rounded-lg shadow-xl z-50 animate-fade-in";const s=v(e);t.innerHTML=`
        <div class="flex items-center gap-3">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
            </svg>
    ...
    `}function me(e){const t=document.getElementById("top-users-list");if(!t)return;if(e.length===0){const o=document.createElement("div");o.className="text-center py-8 text-slate-500",o.innerHTML=`
        ...
        `,s.appendChild(m)}),t.replaceChildren(s)}function It(){Tt(),Bt(),qt()}async function Tt(){const e=document.getElementById("chart-progress");if(e)try{let t,s,o;if(w()){c.info("📈 Mode démo : Création graphique progression simulé..."),t=[],s=[],o=[];for(let r=29;r>=0;r--){const i=new Date;i.setDate(i.getDate()-r),t.push(i.toLocaleDateString("fr-FR",{day:"2-digit",month:"short"})),s.push(Math.floor(Math.random()*15)+5),o.push(Math.floor(Math.random()*20)+70)}}else{const r=new Date;r.setDate(r.getDate()-30);const i=await W(),g=j(N(T,"quizResults"),q("clientId","==",i)),u=await U(g),d={};for(let l=0;l<30;l++){const m=new Date;m.setDate(m.getDate()-l);const E=m.toISOString().split("T")[0];d[E]={count:0,totalScore:0}}u.forEach(l=>{const m=l.data(),E=m.completedAt?.toDate();if(E&&E>=r){const L=E.toISOString().split("T")[0];d[L]&&(d[L].count++,d[L].totalScore+=m.score||0)}}),t=Object.keys(d).reverse().map(l=>new Date(l).toLocaleDateString("fr-FR",{day:"2-digit",month:"short"})),s=Object.values(d).reverse().map(l=>l.count),o=Object.values(d).reverse().map(l=>l.count>0?Math.round(l.totalScore/l.count):0)}const n=x.get("chartProgress");n&&n.destroy();const a=new Chart(e,{type:"line",data:{labels:t,datasets:[{label:"Quiz complétés",data:s,borderColor:"rgb(196, 30, 58)",backgroundColor:"rgba(196, 30, 58, 0.1)",tension:.4,yAxisID:"y",pointBackgroundColor:"rgb(196, 30, 58)",pointBorderColor:"#fff",pointBorderWidth:2},{label:"Score moyen (%)",data:o,borderColor:"rgb(212, 175, 55)",backgroundColor:"rgba(212, 175, 55, 0.1)",tension:.4,yAxisID:"y1",pointBackgroundColor:"rgb(212, 175, 55)",pointBorderColor:"#fff",pointBorderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},scales:{y:{type:"linear",display:!0,position:"left",title:{display:!0,text:"Nombre de quiz"}},y1:{type:"linear",display:!0,position:"right",title:{display:!0,text:"Score moyen (%)"},grid:{drawOnChartArea:!1}}},plugins:{legend:{position:"top"},title:{display:!0,text:"Évolution sur 30 jours"}}}});x.set("chartProgress",a)}catch(t){c.error("❌ Erreur création graphique progression:",t)}}async function Bt(){const e=document.getElementById("chart-modules");if(e)try{const t=await Ae(),s=Object.keys(t),o=Object.values(t).map(i=>i.count),n=["rgba(196, 30, 58, 0.9)","rgba(212, 175, 55, 0.9)","rgba(40, 167, 69, 0.9)","rgba(255, 159, 67, 0.9)","rgba(139, 20, 41, 0.9)"],a=x.get("chartModules");a&&a.destroy();const r=new Chart(e,{type:"doughnut",data:{labels:s,datasets:[{data:o,backgroundColor:n,borderWidth:2,borderColor:"#fff"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom"},title:{display:!0,text:"Répartition par module"}}}});x.set("chartModules",r)}catch(t){c.error("❌ Erreur création graphique modules:",t)}}async function qt(){const e=document.getElementById("chart-activity");if(e)try{const t=[],s=[];for(let a=6;a>=0;a--){const r=new Date;r.setDate(r.getDate()-a),t.push(r.toLocaleDateString("fr-FR",{weekday:"short"})),s.push(Math.floor(Math.random()*20)+5)}const o=x.get("chartActivity");o&&o.destroy();const n=new Chart(e,{type:"bar",data:{labels:t,datasets:[{label:"Utilisateurs actifs",data:s,backgroundColor:"rgba(196, 30, 58, 0.8)",borderColor:"rgb(196, 30, 58)",borderWidth:2,borderRadius:4,hoverBackgroundColor:"rgba(196, 30, 58, 1)"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},title:{display:!0,text:"Activité des 7 derniers jours"}},scales:{y:{beginAtZero:!0,ticks:{stepSize:5}}}}});x.set("chartActivity",n)}catch(t){c.error("❌ Erreur création graphique activité:",t)}}async function jt(){const e=p.showLoadingToast("Génération du PDF...");try{const{jsPDF:t}=window.jspdf,s=new t;s.setFontSize(20),s.text("Dashboard Admin - QuizPro",20,20),s.setFontSize(10),s.text(`Généré le ${new Date().toLocaleDateString("fr-FR")}`,20,30),s.setFontSize(14),s.text("Statistiques Globales",20,45),s.setFontSize(10);let o=55;s.text(`Total Utilisateurs: ${globalStats.totalUsers}`,25,o),o+=7,s.text(`Total Quiz: ${globalStats.totalQuizzes}`,25,o),o+=7,s.text(`Score Moyen: ${globalStats.avgScore}%`,25,o),o+=7,s.text(`Questions: ${globalStats.totalQuestions}`,25,o),o+=7,s.text(`Ressources: ${globalStats.totalResources}`,25,o),s.save(`dashboard-admin-${new Date().toISOString().split("T")[0]}.pdf`),p.updateLoadingToast(e,"PDF généré avec succès !","success")}catch(t){c.error("❌ Erreur export PDF:",t),p.updateLoadingToast(e,"Erreur d'export PDF","error"),p.error("Erreur: Assurez-vous que jsPDF est chargé",4e3)}}async function Nt(){const e=p.showLoadingToast("Génération du CSV...");try{const t=await W(),s=j(N(T,"quizResults"),q("clientId","==",t)),o=await U(s),n=["Date","Utilisateur","Module","Mois","Année","Score (%)","Bonnes réponses","Total questions","Temps (s)"],a=[];o.forEach(u=>{const d=u.data(),l=d.completedAt?.toDate().toLocaleString("fr-FR")||"N/A";a.push([l,d.userName||"Inconnu",d.module||"N/A",d.month||"N/A",d.year||"N/A",d.score||0,d.correctAnswers||0,d.totalQuestions||0,d.timeSpent||0])});const r=[n,...a].map(u=>u.join(",")).join(`
`),i=new Blob([r],{type:"text/csv;charset=utf-8;"}),g=document.createElement("a");g.href=URL.createObjectURL(i),g.download=`dashboard-complet-${new Date().toISOString().split("T")[0]}.csv`,g.click(),p.updateLoadingToast(e,"CSV généré avec succès !","success")}catch(t){c.error("❌ Erreur export CSV:",t),p.updateLoadingToast(e,"Erreur d'export CSV","error"),p.error("Erreur lors de l'export CSV",4e3)}}function Ut(){document.getElementById("export-pdf-btn")?.addEventListener("click",jt),document.getElementById("export-csv-btn")?.addEventListener("click",Nt),document.getElementById("period-filter")?.addEventListener("change",Qt),document.getElementById("refresh-dashboard-btn")?.addEventListener("click",()=>{p.info("Actualisation du dashboard...",2e3),Mt()})}async function Qt(e){const t=e.target.value;p.info(`Filtrage: ${t}`,2e3)}function Ft(){document.getElementById("global-stats-cards")&&F("global-stats-cards",Xe(4)),document.getElementById("top-users-list")&&F("top-users-list",ie(10)),document.getElementById("recent-activity-list")&&F("recent-activity-list",ie(8));const o=document.getElementById("progress-chart");o&&(o.innerHTML=K());const n=document.getElementById("modules-chart");n&&(n.innerHTML=K());const a=document.getElementById("activity-chart");a&&(a.innerHTML=K())}function Pt(e){const s=new Date-e,o=Math.floor(s/1e3),n=Math.floor(o/60),a=Math.floor(n/60),r=Math.floor(a/24);return r>0?`Il y a ${r}j`:a>0?`Il y a ${a}h`:n>0?`Il y a ${n}min`:"À l'instant"}export{te as _,I as a,H as b,F as c,T as d,v as e,ns as f,ts as g,Ke as h,w as i,Zt as j,Xe as k,c as l,os as m,K as n,Xt as o,Yt as p,es as q,ss as r,Jt as s,p as t,Gt as u,Mt as v,as as w,rs as x,Kt as y};
//# sourceMappingURL=admin-DIKPm6mi.js.map
